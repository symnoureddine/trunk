...
import ErrorsBufferProvider from "@providers/ErrorsBufferProvider"
import INTable from "@components/INTable"
import INPagination from "@providers/INPagination"
import INValue from "@components/INValue"

/**
 * Gestion de la page de Monitoring de l'Install
 */
@Component({components: {INTabs, INLoading, INTable, INValue}})
export default class ErreurLog extends Chapitre {
  private logs: object[] = []
  private errors: object[] = []
  private errorsBufferFilesCount: number = 0
  private errorsBufferLastUpdate: string = ""
  private errorsBufferPath: string = ""
  ...
  private moreLogLoaded: boolean = true

  private currentTab: string = "Logs"
  private tabs: object[] = [
    {
      label: this.tr("Logs"),
      id: "Logs"
  ...
  public async load(): Promise<void>{
    ...
    let errorsBufferData = await new ErrorsBufferProvider()
      .getData()
