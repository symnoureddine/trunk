...
use Exception;
use Ox\Installation\Models\CMySQLVersion;
use PDO;

/**
 * PDO encapulation for installation scripts
 */
class CInstallationPDO extends PDO
{
     ...
     */
    public function createMySqlVersion(): CMySQLVersion
    {
        $sql_version                  = new CMySQLVersion();
        $sql_version->name            = CMySQLVersion::VERSION_REQUIRE;
