...
import OxSpecsApi from "@system/OxSpecsApi"
import OxVue from "@system/OxVue"
import OxFieldBoolean from "@system/OxFieldBoolean"
import OxFieldString from "@system/OxFieldString"
import OxFieldDate from "@system/OxFieldDate"
import OxFieldList from "@system/OxFieldList"
import OxFieldText from "@system/OxFieldText"
import OxTooltip from "@system/OxTooltip"
 ...
 * OxSpecField
 */
@Component({ components: { OxFieldBoolean, OxFieldString, OxFieldDate, OxFieldList, OxFieldText, OxTooltip } })
export default class OxSpecField extends OxVue {
    @Prop({ default: "" })
    ...
    private get list (): { _id: string; view: string }[] {
        ...
        return this.specs.values.map(
            (_opt) => {
                return {
                    _id: _opt,
                    view: this.tr(this.specs.owner + "." + this.field + "." + _opt)
                }
            }
        )
    }
