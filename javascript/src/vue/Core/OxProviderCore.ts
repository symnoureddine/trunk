...
import OxTranslatorCore from "@system/OxTranslatorCore"
import { ApiParameters, ApiResponse, ApiTranslatedResponse, BulkElement, BulkResponse } from "@system/ApiResponseModel"
import OxDate from "@system/OxDate"
import OxStoreCore from "@system/OxStoreCore"
import OxLoading from "@system/OxLoading"
import OxBulkCore from "@system/OxBulkCore"
...
export default class OxProviderCore {
    ...
    public async postApi (url = "", params?: {}): Promise<ApiTranslatedResponse> {
        ...
        return this.callApi(
            async (url) => {
                ...
                return await transformer.post(url, this.params)
            },
            url
    ...
    public async putApi (url = "", params?: {}): Promise<ApiTranslatedResponse> {
        ...
        return this.callApi(
            async (url) => {
                ...
                return await transformer.put(url, this.params)
            },
            url
        ) as Promise<ApiTranslatedResponse>
    }
    ...
    private async callApi (promise: Function, url = "", transformer?: Function): Promise<ApiTranslatedResponse | ApiTranslatedResponse[]> {
        ...
        try {
            ...
            const data = await (new OxTranslatorCore(apiResponse.data, apiResponse.meta, apiResponse.links, apiResponse.included, this.indexSpecs))
                .translateData()
            if (transformer) {
