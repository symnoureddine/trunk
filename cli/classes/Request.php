...
class Request extends MediboardCommand {
  const MEDIBOARD_LOG = "/var/log/mediboard/request.log";
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
    ...
    if ($this->mutex) {
      ...
      $key = "cli-lock-$hash-".strftime("%Y-%m-%d %H:%M");
  ...
  protected function getMutexMaster() {
    include_once __DIR__ . "/../../core/classes/CRedisClient.php";
    include_once __DIR__ . "/../../core/classes/CRedisConnection.php";
  ...
  protected function formatText($text) {
    return strftime("[%Y-%m-%d %H:%M:%S] ") . $this->getMediboardView() . " " . $text;
  }
