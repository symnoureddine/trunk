...
if ($operation->graph_pack_preop_id) {
  list($perop_datetime_min, $perop_datetime_max) = CObservationResultSet::getTimingsByType($operation, "preop", $print);
...
if ($operation->graph_pack_id) {
  list($perop_datetime_min, $perop_datetime_max) = CObservationResultSet::getTimingsByType($operation, "perop" , $print);
...
if ($operation->graph_pack_sspi_id) {
  list($sspi_datetime_min, $sspi_datetime_max) = CObservationResultSet::getTimingsByType($operation, "sspi", $print);
