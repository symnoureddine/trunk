...
GestePerop = {
  ...
  bindElementPrecision: function (element, geste_id, geste_libelle) {
    ...
    if (element.type === 'checkbox' && !element.checked) {
      if ($('li_geste_' + geste_id + '_precision_' + element_id)) {
        $('li_geste_' + geste_id + '_precision_' + element_id).remove();
      }
    ...
    if ($('li_geste_' + geste_id)) {
      $('li_geste_' + geste_id).remove();
    }

    var li = DOM.li({
        id: 'li_geste_' + geste_id + '_precision_' + element_id,
        className: 'tag geste_selected',
        style: 'cursor: default;'
      },
  ...
  bindElementValeur: function (element, geste_id, geste_libelle, precision_id, precision_libelle) {
    ...
    if (element.type === 'checkbox' && !element.checked) {
      if ($('li_geste_' + geste_id + '_precision_' + precision_id + '_valeur_' + element_id)) {
        $('li_geste_' + geste_id + '_precision_' + precision_id + '_valeur_' + element_id).remove();
      }
    ...
    if ($('li_geste_' + geste_id + '_precision_' + precision_id)) {
      $('li_geste_' + geste_id + '_precision_' + precision_id).remove();
    }

    var li = DOM.li({
        id: 'li_geste_' + geste_id + '_precision_' + precision_id + '_valeur_' + element_id,
        className: 'tag geste_selected',
        style: 'cursor: default;'
      },
  ...
  showPrecisionValues: function (geste_perop_precision_id) {
    new Url("dPsalleOp", "ajax_vw_precision_valeurs")
