...
<table class="tbl me-no-align me-small">
  <tr>
    ...
    <th
      class="me-small-fields">{{mb_colonne class="COperation" field="_patient" order_col=$order_col order_way=$order_way function=orderTabout}}
      <input type="text" name="_seek_patient_preop" value="" class="seek_patient" onkeyup="seekPatient(this);"
             onchange="seekPatient(this);"/></th>
    ...
    {{if $use_sortie_reveil_reel}}
      <th style="width: 15%"
          class="me-ws-wrap">{{mb_colonne class="COperation" field="sortie_reveil_possible" order_col=$order_col order_way=$order_way function=orderTabout}}</th>
      <th
        style="width: 15%">{{mb_colonne class="COperation" field="sortie_reveil_reel" order_col=$order_col order_way=$order_way function=orderTabout}}</th>
    {{else}}
      <th
        style="width: 15%">{{mb_colonne class="COperation" field="sortie_reveil_reel" order_col=$order_col order_way=$order_way function=orderTabout}}</th>
    {{/if}}
    <th
      style="width: 15%">{{mb_colonne class="COperation" field="sortie_sans_sspi" order_col=$order_col order_way=$order_way function=orderTabout}}</th>
    <th class="narrow"></th>
  </tr>
