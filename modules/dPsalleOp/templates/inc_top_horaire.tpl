...
{{if $timing === "entree_bloc" && !$conf.dPsalleOp.COperation.use_entree_bloc}}
  {{mb_return}}
{{/if}}
...
{{if in_array($timing, array("entree_salle", "sortie_salle")) && !$conf.dPsalleOp.COperation.use_entree_sortie_salle}}
  {{mb_return}}
{{/if}}
...
{{if in_array($timing, array("debut_op", "fin_op")) && !$conf.dPsalleOp.COperation.use_debut_fin_op}}
  {{mb_return}}
{{/if}}
...
{{if $timing === "remise_chir" && !$conf.dPsalleOp.COperation.use_remise_chir}}
  {{mb_return}}
{{/if}}
...
{{if $timing === "sortie_reveil_reel" && !$conf.dPsalleOp.COperation.use_sortie_sans_sspi}}
  {{mb_return}}
{{/if}}
