  ...
  <tr>
    ...
    <td class="halfPane">
      <table width="100%" style="font-size: 100%;">
        ...
        {{if $conf.dPsalleOp.COperation.use_garrot && !'dPsalleOp COperation garrots_multiples'|gconf}}
          <tr>
      ...
      <table width="100%" style="font-size: 100%;">
        ...
        {{if $conf.dPsalleOp.COperation.use_cleaning_timings && $operation->_cleaning_time}}
          <tr>
    ...
    {{foreach from=$_perops_by_datetime item=_perop}}
      <tr>
        ...
        {{if is_object($_perop)}}
          ...
          {{elseif $_perop|instanceof:'Ox\Mediboard\PlanSoins\CAdministrationDM'}}
