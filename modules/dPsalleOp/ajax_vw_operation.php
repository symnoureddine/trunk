...
// Lors de l'affichage des interventions par praticien, l'information de salle n'est pas transmise
// On la récupère donc de l'intervention directement
if (!$salle_id) {
    $salle_id = $selOp->salle_id;
}
...
if ($salle_id) {
  ...
  if ($require_check_list) {
    list($check_list_not_validated, $daily_check_list_types, $daily_check_lists) = CDailyCheckList::getCheckLists($salle, $date, "ouverture_salle", $load_checklist);
