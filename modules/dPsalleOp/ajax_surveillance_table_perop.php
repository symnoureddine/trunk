...
list($results, $times) = CObservationResultSet::getResultsFor($operation);

list ($time_min, $time_max, $time_debut_op_iso, $time_fin_op_iso) = CObservationResultSet::getLimitTimes($operation, $type);
