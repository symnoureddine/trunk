...
$pec_transport = [
    "ambu"  => CAppui::gconf("dPurgences pec_transport ambu"),
    "fo"    => CAppui::gconf("dPurgences pec_transport fo"),
    "heli"  => CAppui::gconf("dPurgences pec_transport heli"),
    "perso" => CAppui::gconf("dPurgences pec_transport perso"),
    "smur"  => CAppui::gconf("dPurgences pec_transport smur"),
    "vsav"  => CAppui::gconf("dPurgences pec_transport vsav"),
];
...
$smarty->assign('pec_transport', json_encode($pec_transport));
