...
<div id="lit_bloque_topo" class="lit_bloque_urgences clit_bloque draggable me-margin-10" style="display: inline-block;">
    <strong>[{{tr}}CChambre-BLOCK A BED{{/tr}}]</strong>
</div>
<script>
    Main.add(function () {
        new Draggable($('lit_bloque_topo'), {revert: true});
    });
</script>
