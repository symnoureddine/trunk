...
{
    /** @var string */
    public static $email_to = "interop@openxtrem.com";
     ...
     * @throws \Exception
     */
    public static function notifyRPUError(CExtractPassages $passage): void
    {
        if (!$passage->_id) {
            return;
        }
    ...
    /**
     * Send email at interop@openxtrem.com
     *
