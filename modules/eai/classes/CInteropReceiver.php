...
class CInteropReceiver extends CInteropActor
{
     ...
     * @throws Exception
     */
    static function countObjects($curent_group = null)
    {
        $objects = [];
    ...
    {
        return CApp::getChildClasses(CInteropReceiver::class, true, true);
    }
     ...
     * @throws Exception
     */
    static function getObjects($only_active = false, $curent_group = null, $put_all_sources = false)
    {
        $objects = [];
        foreach (self::getChildReceivers() as $_interop_receiver) {
            /** @var CInteropReceiver $receiver */
