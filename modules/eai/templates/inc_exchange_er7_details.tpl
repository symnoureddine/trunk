...
{{mb_default var=msg_segment_group_initial value=null}}
<tr>
  <td>
    <script>
      Main.add(function () {
    ...
    <div id="msg-message" style="display: none;">
          ...
          Control.Tabs.create("msg-message-tab", true, {afterChange: function(newContainer) {
            switch(newContainer.id) {
              case "msg-message-fast-queries" :
                ...
                break;
              case "msg-message-edit-message" :
                ExchangeDataFormat.getInfoMessageHL7('{{$exchange->_guid}}');
                break;
              case "show-file" :
      ...
      <ul class="control_tabs" id="msg-message-tab">
        ...
        {{if $msg_segment_group_initial}}<li><a href="#msg-altered-content-id">Message sans transformation</a></li>{{/if}}
        <li><a href="#msg-message-fast-queries">Requêtes rapides</a></li>
        <li><a href="#msg-message-query">Requêteur</a></li>
        <li><a href="#msg-message-edit-message">IPP / NDA</a></li>
        <li><a href="#show-file">Vue du fichier HL7</a></li>
      </ul>

      <ul id="msg-message-tree" class="hl7-tree" style="display: none;">
      ...
      <div id="msg-message-xml" style="display: none; height: 410px;" class="highlight-fill">
      ...
      {{if $msg_segment_group_initial}}
        <div id="msg-altered-content-id">
          {{$msg_segment_group_initial->flatten(true)|smarty:nodefaults}}
        </div>
      {{/if}}
      ...
      <div id="msg-message-edit-message" style="display : none;"></div>
      <div id="show-file" style="display : none;"></div>
    </div>
    ...
    <div id="ack" style="display: none;">
      ...
      <ul id="ack-message-tree" class="hl7-tree" style="display: none;">
