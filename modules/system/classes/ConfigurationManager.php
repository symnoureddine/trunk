 ...
 *
 * Will be refactored in order to handle all kind of CConfiguration and allow the suppression of CConfigurationModelManager class
 *
...
final class ConfigurationManager {
  ...
  public function getValue(string $key) {
    if (!$this->isReady()) {
      throw new ConfigurationNotReadyException('ConfigurationManager-error-The configuration manager is not ready');
    }
  ...
  private function buildValues(string $module): array {
    ...
    if ($default_values === null) {
      $default_values = array_merge($this->getDefaultValues($module, []), $this->getStoredConfigurations($module, [], null));
  ...
  private function getStoredConfigurations(string $module, array $keys = [], IConfigurationStrategy $strategy = null) {
    ...
    $configurations = $strategy->getStoredConfigurations($module, $spec, true);
   ...
   * @throws Exception
   */
  public function getAncestorsConfigs(string $module, array $config_keys = [], IConfigurationStrategy $strategy = null): array {
