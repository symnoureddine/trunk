...
class CLongRequestLog extends CStoredObject {
  ...
  function getModuleAction() {
    ...
    $get  = is_array($this->_query_params_get) ? $this->_query_params_get : array();
    $post = is_array($this->_query_params_post) ? $this->_query_params_post : array();
  ...
  function getProps() {
    ...
    $props["user_id"]           = "ref class|CMediusers back|long_request_log";
   ...
   * @return void
   */
  public function computePerformanceRatio() {
    if (!$this->_query_performance) {
      return;
    }
