 ...
 * Action Button
 */
class CExClassFieldActionButton extends CMbObject {
  ...
  static $compat = array(
    ...
    "text"      => array("text", "str"),
    "bool"      => array("str", "text"),
    "num"       => array("num", "str", "text", "float", "pct", "currency"),
    "float"     => array("float", "str", "text", "num", "pct", "currency"),
    "date"      => array("date", "str", "text", "dateTime"),
    "time"      => array("time", "str", "text"),
    "dateTime"  => array("dateTime", "date", "str", "text"),
    "pct"       => array("pct", "str", "text", "float", "num", "currency"),
    "phone"     => array("phone", "str", "text"),
    "birthDate" => array("birthDate", "date"),
    "currency"  => array("currency", "str", "text", "float", "num", "pct"),
    "email"     => array("email", "str", "text"),
  );
