 ...
 * Form constraint
 */
class CExClassMandatoryConstraint extends CMbObject {
  ...
  function getSpec() {
    ...
    $spec->uniques["constraint"] = array("ex_class_event_id", "field", "value", "reference_value");
    ...
    if ($this->reference_value !== null) {
      switch ($this->reference_value) {
        case 'now':
          ...
          $value_comp = ($object->_specs[$field] instanceof CDateSpec) ? CMbDT::date($_reference_date) : CMbDT::dateTime($_reference_date);
          break;
