...
<form name="EditConfig-placeholders" method="post" onsubmit="return onSubmitFormAjax(this);">
  {{mb_configure module=$m}}

  <table class="form">
    <tr>
      <th class="title" colspan="2">{{tr}}template_placeholders{{/tr}}</th>
    </tr>

    {{assign var=class value='template_placeholders'}}

    {{foreach from=$conf.template_placeholders key=var item=value}}
