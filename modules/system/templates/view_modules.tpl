...
{{if $coreModules|@count}}
  <div class="big-warning">
    ...
    Veuillez les mettre à jour, <b>en commencant par le module Administartion</b>, afin de supprimer ces erreurs résultantes et avoir accès aux autres modules
  </div>
...
<div id="assistant" style="display: none;">
  <br>
  <a class="button fas fa-external-link-alt" target="_blank" href="installation">
    Etat de l'instance
  </a>
</div>
