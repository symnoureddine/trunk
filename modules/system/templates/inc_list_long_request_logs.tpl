  ...
  {{foreach from=$logs item=_log}}
    <tr>
      ...
      <td class="narrow">
        ...
        <div class="progressBar" style="display: inline-block; width: 40px;" title="{{$ratio}} % du temps passé en requêtes aux sources de données (SGBD, Redis...) et {{$ratio_transport}} % en transport tiers (ftp, http, filesystem ...)">
