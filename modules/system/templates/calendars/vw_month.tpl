            ...
            <div class="day_events">
              ...
              {{foreach from=$_events item=_event}}
                {{if $i<3}}
                  <div id="{{$_event->guid}}" class="{{$_event->css_class}} event me-add-elevation-2"
                       {{if $_event->color}}style="border-left:solid 4px {{$_event->color}}" {{/if}} data-type="{{$_event->type}}"
              ...
              {{if sizeof($_events) > 3}}
                ...
                <div class="more more-{{$id}}">
                  <p class="day_number" style="text-align: center;"><strong>{{$_day|date_format:"%A %d"}}</strong></p>
                  {{foreach from=$_events item=_event}}
                    <div id="{{$_event->guid}}"
