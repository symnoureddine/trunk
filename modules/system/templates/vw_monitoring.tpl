...
<script>
  Main.add(function () {
    ...
    showRessourcesLogs = function () {
      new Url('system', 'view_ressources_logs')
        .requestModal('90%', '90%');
    };
    ...
    <td class="halfPane me-no-border" rowspan="2">
      <fieldset>
        ...
        <table class="main layout">
          ...
          <tr>
            <td>
              <button class="stats me-tertiary" type="button"
                      onclick="showRessourcesLogs()">{{tr}}mod-system-tab-view_ressources_logs{{/tr}}</button>
            </td>
            <td class="text compact">
              {{tr}}mod-system-tab-view_ressources_logs-desc{{/tr}}
            </td>
          </tr>
        </table>
      </fieldset>
