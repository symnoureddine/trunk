...
<form name="form-create-dsn-{{$dsn}}" action="?" method="post" onsubmit="return DSN.create(this);">
  ...
  <input type="hidden" name="dosql" value="do_create_dsn"/>
  <input type="hidden" name="dsn" value="{{$dsn}}"/>

  <div class="small-info" style="white-space: normal;">
    Veuillez spécifier les identifiants de l'administrateur de base de données pour créer la base de données, et les droits
    nécessaires.
  </div>
