...
<div id="bdd">
  ...
  <table class="tbl" style="table-layout: fixed;">
    ...
    <tr>
      <td><button class="tick" onclick="importDB(true)" >Vérifier la dernière version disponible</button></td>
      <td id="db-version"></td>
    </tr>

    <tr>
      <td><button class="tick" onclick="importDB()" >Importer la base de données LPP</button></td>
      <td id="db-import"></td>
    </tr>
    <tr>
      <td><button class="tick" onclick="importChapters();">Importer les chapitres de la LPP</button></td>
