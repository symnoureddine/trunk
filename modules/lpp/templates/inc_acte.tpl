...
<script>
  Main.add(function() {
    {{if !$acte_lpp->_id}}
      ...
      var url = new Url('lpp', 'ajax_code_autocomplete');
...
<tr>
  <td>
    <form name="{{$form}}-code" action="?" method="post" onsubmit="return false">
      {{if $acte_lpp->_id}}
        {{mb_field object=$acte_lpp field=code onchange="syncActField('$form', 'code', \$V(this));" readonly=true}}
      {{else}}
        {{mb_field object=$acte_lpp field=code onchange="syncActField('$form', 'code', \$V(this));"}}
  ...
  <td>
    <form name="{{$form}}-code_prestation" action="?" method="post" onsubmit="return false">
      {{mb_field object=$acte_lpp field=code_prestation readonly=true onchange="syncActField('$form', 'code_prestation', \$V(this));"}}
    </form>
  </td>
  <td>
    <form name="{{$form}}-type_prestation" action="?" method="post" onsubmit="return false">
      {{mb_field object=$acte_lpp field=type_prestation readonly=true emptyLabel="Select" onchange="syncActField('$form', 'type_prestation', \$V(this));"}}
    </form>
  </td>
  <td>
    <form name="{{$form}}-executant_id" action="?" method="post" onsubmit="return false">
      {{mb_field object=$acte_lpp field=executant_id onchange="syncActField('$form', 'executant_id', \$V(this));" hidden=true}}
  ...
  <td>
    <form name="{{$form}}-date" action="?" method="post" onsubmit="return false">
      {{mb_field object=$acte_lpp field=date register=true form=$form|cat:'-date' onchange="syncActField('$form', 'date', \$V(this));"}}
    </form>
  </td>
  <td>
    <form name="{{$form}}-date_fin" action="?" method="post" onsubmit="return false">
      {{mb_field object=$acte_lpp field=date_fin register=true form=$form|cat:'-date_fin' onchange="syncActField('$form', 'date_fin', \$V(this));"}}
    </form>
  </td>
  <td>
  ...
  <td>
    <form name="{{$form}}-qualif_depense" action="?" method="post" onsubmit="return false">
      <select name="qualif_depense" onchange="syncActField('{{$form}}', 'accord_prealable', $V(this));" style="width: 10em;">
  ...
  <td>
    ...
    {{mb_field object=$acte_lpp field=quantite onchange="changePrice('$form', 'quantite', \$V(this));" size=3}}
    </form>
  </td>
  <td>
    <form name="{{$form}}-montant_base" action="?" method="post" onsubmit="return false">
    {{mb_field object=$acte_lpp field=montant_base readonly=true onchange="changePrice('$form', 'montant_base', \$V(this));" style="size: 4;"}}
    </form>
  </td>
  <td>
    <form name="{{$form}}-montant_final" action="?" method="post" onsubmit="return false">
    {{mb_field object=$acte_lpp field=montant_final onchange="syncActField('$form', 'montant_final', \$V(this));" style="size: 4;"}}
    </form>
  </td>
