...
class CSetupAstreintes extends CSetup {
  function __construct() {
    ...
    $this->addDefaultConfig("astreintes General astreinte_informatique_color", "astreintes astreinte_informatique_color");
    $this->addDefaultConfig("astreintes General astreinte_medical_color", "astreintes astreinte_medical_color");
    $this->addDefaultConfig("astreintes General astreinte_personnelsoignant_color", "astreintes astreinte_personnelsoignant_color");
