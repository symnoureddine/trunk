...
if ($ds && !$ds->hasTable('hd_etablissement', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd etab create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_activite', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd activite create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_activite_zone', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd activite zone create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_finance', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd finances create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_process', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd process create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_qualite', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd qualite create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_resshum', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd resshum create', UI_MSG_OK);
}
...
if (!$ds->hasTable('hd_identite', false)) {
  ...
  CAppUI::setMsg('openData-msg-Hd identite create', UI_MSG_OK);
}
