...
class CConsultAnesth extends CMbObject implements IPatientRelated, IIndexableObject, ImportableInterface {
  ...
  function fillLimitedTemplate(&$template) {
    ...
    $template->addProperty("$anesth_section - " . CAppUI::tr('CConsultAnesth-rques'), $this->rques);
  ...
  function storeFicheAnesthPdf() {
    ...
    $urls = array("fiche_anesth" => $url);
    CWkhtmlToPDF::makePDF($this, $name_file, $urls, "A4", "Portrait", "print");
  }
