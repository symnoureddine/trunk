...
{{if !$type_see || $type_see == "antecedent"}}
  ...
  {{if "soins Other ignore_allergies"|gconf && !$dossier_medical->_ref_antecedents_by_type.alle|@count && !$create_antecedent_only_prat}}
  ...
  {{if "maternite"|module_active && $sejour->_ref_naissance->_id}}
