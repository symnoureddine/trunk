...
*}}
{{if "ameli CCerfa use_cerfa"|gconf && "ameli"|module_active}}
  {{mb_script module=ameli script=Cerfa register=true}}
{{/if}}
  ...
  <table class="form" style="width: 100%;">
    ...
    <tr>
      <td class="button" colspan="2">
        {{if "ameli CCerfa use_cerfa"|gconf && "ameli"|module_active && $show_button_cerfa}}
