    ...
    <tr>
      ...
      <th class="title text" style="border: none;">
        ...
        {{if $consult->chrono <= $consult|const:'EN_COURS'}}
          /
          {{if $consult_anesth && $consult_anesth->_id}}
            <button id="didac_consult_button_terminer" class="tick" type="button" onclick="checkConsult('{{$consult_anesth->_id}}');">
          {{else}}
        ...
        {{elseif $consult_anesth && $consult_anesth->_id}}
          <button id="didac_button_IPAQSS" class="search" type="button" onclick="checkConsult('{{$consult_anesth->_id}}');">
