...
class CSearchIndexing extends CStoredObject
{
     ...
     * @throws Exception
     */
    public static function getDataToIndex($limit, $class = null): array
    {
     ...
     * @return String
     */
    public function normalizeEncoding($text): string
    {
     ...
     */
    public static function getRawText($content): string
    {
        $content = strtr(
            $content,
            [
     ...
     * @return void
     */
    public function firstIndexingStore($object_classes): void
    {
        $date = CMbDT::dateTime();
        $ds   = $this->getDS();
