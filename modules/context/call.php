...
$mods_available = [
    ...
    'ecap_soins_prescription_sejour' => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_patient'             => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_constantes'          => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_suivi'               => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_prescription'        => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_labo'                => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_documents'           => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    'ecap_soins_antecedents'         => ['soins', 'ajax_vw_dossier_sejour', 'sejour'],  // eCap - Soins
    ...
    'galaxie_prescription'           => ['galaxie', 'externalPrescriptionView', 'consultation'],
];
...
if ($mods_available[$view][2] == 'consultation') {
    ...
    $url = formRequest($mods_available[$view]) . "&appointment_id={$consultation->_id}";
    CAppUI::redirect($url);
}
...
if ($mods_available[$view][2] == 'patient') {
  if (!$patient->_id && !in_array($view, array("intervention", "sejour", "documents"))) {
    if ($patient->_IPP) {
