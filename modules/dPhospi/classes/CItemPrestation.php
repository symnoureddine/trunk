...
use Ox\AppFine\Server\Controllers\CAccountController;
...
class CItemPrestation extends CMbObject {
  /** @var string  */
  public const RESOURCE_NAME = 'item_prestation';
  /** @var string  */
   ...
   * @throws Exception
   */
  public function getResourcePrestationJournaliere(): ?CItem {
    $prestation_journaliere = $this->loadRefObject();
    if (!$prestation_journaliere || !$prestation_journaliere->_id) {
      return null;
    }

    $res = new CItem($prestation_journaliere);
    $res->setName(CPrestationJournaliere::RESOURCE_NAME);
     ...
     * @throws Exception
     */
    public function getResourceAfItemsLiaison(): ?CCollection
    {
        ...
        $res = new CCollection($af_items);
        $res->setName(CAppFineItemLiaison::RESOURCE_NAME);
   ...
   * @throws Exception
   */
  public function getResourceSousItems(): ?CCollection {
    $sous_items = $this->loadRefsSousItems();
    if (!$sous_items) {
      return null;
    }

    $res = new CCollection($sous_items);
    $res->setName(CSousItemPrestation::RESOURCE_NAME);
