...
class CUniteFonctionnelleController extends CController {
   ...
   * @api
   */
  public function listUfs(CRequestApi $request_api, $type): Response {
    ...
    $resource = CCollection::createFromRequest($request_api, $ufs);
   ...
   * @api
   */
  public function showUf(CRequestApi $request_api, CUniteFonctionnelle $uf): Response {
    return $this->renderApiResponse(CItem::createFromRequest($request_api, $uf));
  }
}
