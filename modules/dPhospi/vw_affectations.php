...
if (CCanDo::edit()) {
  ...
  foreach ($groupSejourNonAffectes as $moment => $_groupSejourNonAffectes) {
    switch ($triAdm) {
      case "date_entree":
        array_multisort(
          CMbArray::pluck($groupSejourNonAffectes[$moment], "entree_prevue"), SORT_ASC, $groupSejourNonAffectes[$moment]
        );
        break;

      case "praticien":
        array_multisort(
          CMbArray::pluck($groupSejourNonAffectes[$moment], "_ref_praticien", "function_id"), SORT_ASC,
          CMbArray::pluck($groupSejourNonAffectes[$moment], "_ref_praticien", "_user_last_name"), SORT_ASC,
          CMbArray::pluck($groupSejourNonAffectes[$moment], "_ref_praticien", "_user_first_name"), SORT_ASC,
      ...
      case "patient":
        array_multisort(
          CMbArray::pluck($groupSejourNonAffectes[$moment], "_ref_patient", "nom"), SORT_ASC,
          CMbArray::pluck($groupSejourNonAffectes[$moment], "_ref_patient", "prenom"), SORT_ASC,
          $groupSejourNonAffectes[$moment]
        );
        break;
  ...
  switch ($triAdm) {
    case "date_entree":
      array_multisort(
        CMbArray::pluck($affectations, "_ref_sejour", "entree_prevue"), SORT_ASC,
        $affectations
      );
      break;
    ...
    case "praticien":
      array_multisort(
        CMbArray::pluck($affectations, "_ref_sejour", "_ref_praticien", "function_id"), SORT_ASC,
        CMbArray::pluck($affectations, "_ref_sejour", "_ref_praticien", "_user_last_name"), SORT_ASC,
        CMbArray::pluck($affectations, "_ref_sejour", "_ref_praticien", "_user_first_name"), SORT_ASC,
        $affectations
      );
      break;
    ...
    case "patient":
      array_multisort(
        CMbArray::pluck($affectations, "_ref_sejour", "_ref_patient", "nom"), SORT_ASC,
        CMbArray::pluck($affectations, "_ref_sejour", "_ref_patient", "prenom"), SORT_ASC,
        $affectations
      );
      break;
