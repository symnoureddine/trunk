      ...
      <div class="toolbar_affectation me-margin-top--3">
        {{if "dPhospi vue_temporelle display_placer_couloir"|gconf}}
          <button type="button"
                  ...
                  class="opacity-40 door-out notext me-tertiary" onmouseover="this.toggleClassName('opacity-40')"
    ...
    {{if !$readonly}}
      <table class="layout_affectation" style="z-index: 2; position: relative;">
        <tr>
          ...
          <td class="me-line-height-normal" style="vertical-align: top; {{if $mode_vue_reelle == "classique"}}overflow: hidden;{{/if}}">
            {{if $sejour->_id}}
              <div style="width: 10px; margin-bottom: 1px; {{if $sejour->type == "ambu"}}font-style: italic;{{/if}}"
                   class="me-width-auto
              ...
              {{if $sejour->rques}}
                <i class="fas fa-exclamation-circle" title="{{$sejour->rques}}" style="cursor: help; color:red;"></i>
              {{/if}}
      ...
      <script>
        ...
        new Draggable(container, {
          ...
          onStart:      function (drgObj, mouseEvent) {
            ...
            {{if !$is_aff && $conf.ref_pays != 2 && $prestation_id && $object->_first_liaison_for_prestation->_id && $object->_first_liaison_for_prestation->item_souhait_id}}
