              ...
              {{if !$_affectation->sejour_id}}
                <tr class="dates">
                  <td class="text" colspan="3">
                    {{if $can->edit}}
                      <form name="entreeAffectation{{$_affectation->_id}}" action="?m={{$m}}" method="post" style="float: right;"
                            class="prepared">
                        {{mb_class object=$_affectation}}
                        {{mb_key   object=$_affectation}}
                ...
                <tr class="dates">
                  <td class="text" colspan="3">
                    {{if $can->edit && (!$sejour->sortie_reelle || $aff_next->_id)}}
                      <form name="sortieAffectation{{$_affectation->_id}}" action="?m={{$m}}" method="post" style="float: right;"
                            class="prepared">
                        {{mb_class object=$_affectation}}
                        {{mb_key   object=$_affectation}}
                ...
                <tr class="dates">
                  <td class="text" colspan="3">
                    ...
                    {{if $can->edit && (!$sejour->entree_reelle || $aff_prev->_id)}}
                      <form name="entreeAffectation{{$_affectation->_id}}" method="post" style="float: right;" class="prepared">
                        {{mb_class object=$_affectation}}
                        {{mb_key   object=$_affectation}}
                        <input type="hidden" name="entree" class="dateTime notNull" value="{{$_affectation->entree}}"
