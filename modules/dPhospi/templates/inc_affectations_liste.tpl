...
{{foreach from=$sejourNonAffectes item=_sejour}}
  ...
  <table class="form sejourcollapse treegrid me-no-border me-margin-top-0 me-no-border-radius-top" id="sejour_{{$_sejour->_id}}">
    <tbody>
      <tr>
      ...
      <tr>
        <td colspan="2">
          <form name="EditSejour{{$_sejour->_id}}" action="?m=hospi" method="post" onsubmit="return onSubmitFormAjax(this);">
            ...
            <br />
            <input type="radio" class="me-small" name="septique" value="0" {{if $_sejour->septique == 0}}checked{{/if}} />
            <label for="septique_0" title="Intervention propre">Propre</label>
            <input type="radio" class="me-small" name="septique" value="1" {{if $_sejour->septique == 1}}checked{{/if}} />
