...
array_multisort(
  CMbArray::pluck($affectations_uf, "_ref_uf", "type"), SORT_ASC,
  CMbArray::pluck($affectations_uf, "_ref_uf", "type_sejour"), SORT_ASC, $affectations_uf
);
...
if ($object instanceof CMediusers || $object instanceof CFunctions) {
  ...
  $ufs_secondaire_selected = array("medicale" => false);
