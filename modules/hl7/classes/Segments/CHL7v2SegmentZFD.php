...
class CHL7v2SegmentZFD extends CHL7v2Segment
{
    ...
    function build(CHEvent $event, $name = null)
    {
        ...
        // CB - Code à barre
        // RFID - Puce RFID
        $data[] = $source_identite_active->mode_obtention ? CHL7v2TableEntry::mapTo(
            "9003",
            $source_identite_active->mode_obtention
        ) : null;

        // ZFD-6 : Date d'interrogation du téléservice INSi
        $data[] = $source_identite_active->mode_obtention === 'insi' ? $source_identite_active->debut : null;
        ...
        $data[] = $source_identite_active->type_justificatif ? CHL7v2TableEntry::mapTo(
            "9004",
            $source_identite_active->type_justificatif
        ) : null;
