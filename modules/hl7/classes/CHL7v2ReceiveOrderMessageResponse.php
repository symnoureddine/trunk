...
/**
 * Class CHL7v2ReceiveOrderMessageResponse
 * Receive order message response, message XML HL7
 */
class CHL7v2ReceiveOrderMessageResponse implements CHL7Acknowledgment, IShortNameAutoloadable {
  /**
   * @var CHL7Event|null
   */
  public $event;
   ...
   *
   * @return CHL7v2ReceiveOrderMessageResponse
   */
