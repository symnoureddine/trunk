...
class CHL7v2EventORUR01 extends CHL7v2EventDEC implements CHL7EventORUR01
{
     ...
     * @return void
     */
    function addPV1(CSejour $sejour, $set_id = 1, CMbObject $reference_object = null)
    {
     ...
     * @return void
     */
    function addOBX(CMbObject $object, CDocumentItem $docItem)
    {
     ...
     * @return void
     */
    function addORC(CMbObject $object)
    {
