...
class CHL7v2EventADT extends CHL7v2Event implements CHL7EventADT
{
     ...
     * @return void
     */
    public function addEVN($planned_datetime = null, $occured_datetime = null)
    {
     ...
     * @return void
     */
    public function addPID(CPatient $patient, CSejour $sejour = null)
    {
     ...
     * @return void
     */
    public function addPD1(CPatient $patient)
    {
    ...
    public function addROLs(CPatient $patient): void
    {
        ...
        if ($patient->_ref_medecin_traitant->_id) {
            ...
            if ($patient->fieldModified("medecin_traitant")) {
                $ROL->action = !$patient->_old->_id || !$patient->_old->medecin_traitant ? 'AD' : 'UP';
            } else {
                // UC = Sans changement
                $ROL->action = "UC";
            }
        ...
        if (!$patient->_ref_medecin_traitant->_id) {
            $old_object = $patient->loadOldObject();
            if ($old_object && $old_object->_id && $old_object->medecin_traitant) {
                $ROL          = CHL7v2Segment::create("ROL", $this->message);
     ...
     * @throws CHL7v2Exception
     */
    public function addNK1s(CPatient $patient)
    {
        $i = 1;
     ...
     * @return void
     */
    public function addPV1(CSejour $sejour = null, $set_id = 1)
    {
     ...
     * @return void
     */
    public function addPV2(CSejour $sejour = null)
    {
     ...
     * @throws CHL7v2Exception
     */
    public function addMRG(CMbObject $deleted_object)
    {
     ...
     * @throws CHL7v2Exception
     */
    public function addZBE(CSejour $sejour = null)
    {
     ...
     * @return void
     */
    public function addZFA(CPatient $patient = null)
    {
     ...
     * @return void
     */
    public function addZFP(CSejour $sejour = null)
    {
     ...
     * @throws CHL7v2Exception
     */
    public function addZFV(CSejour $sejour = null)
    {
     ...
     * @throws CHL7v2Exception
     */
    public function addZFM(CSejour $sejour = null)
    {
     ...
     * @return void
     */
    public function addZFD(CPatient $patient = null)
    {
     ...
     * @return void
     */
    public function addGT1(CPatient $patient = null)
    {
    }
     ...
     * @return void
     */
    public function addIN1(CPatient $patient, $set_id = 1)
    {
     ...
     * @return void
     */
    public function addIN2(CPatient $patient, $set_id = 1)
    {
        if (!$patient->code_regime && !$patient->caisse_gest && !$patient->centre_gest) {
            return;
        }
     ...
     * @throws CHL7v2Exception
     */
    public function addOBXs(CPatient $patient)
    {
     ...
     * @throws CHL7v2Exception
     */
    public function addIAMs(CPatient $patient, CAntecedent $antecedent)
    {
        $i           = 1;
