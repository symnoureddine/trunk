...
class CHL7v2Message extends CHMessage {
   ...
   * @param string           $xpath_check_node  noeud pour lequel on veut vérifier une valeur avant de modifier le noeud
   ...
   * @return string|null
   */
  static function getIdentifier($xml, $xpath_parent_node, $xpath_search_node = null,
     $xpath_check_node = null, $check_value = null, $sub_field = null, $delimiter = null) {
   ...
   */
  static function setIdentifier($xml, $xpath_parent_node, $new_value, $xpath_change_node = null,
      $xpath_check_node = null, $check_value = null, $sub_field = null, $delimiter = null) {
   ...
   * @return array|null
   */
  static function getMultipleValues ($xml, $xpath_parent_node, $xpath_search_node = null,
      $xpath_check_node = null, $check_value = null, $sub_field = null, $delimiter = null) {
