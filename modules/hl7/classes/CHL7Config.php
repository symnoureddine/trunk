...
class CHL7Config extends CExchangeDataFormatConfig
{
    ...
    function getProps()
    {
        ...
        $props['sender_class'] = 'enum list|CSenderFTP|CSenderSFTP|CSenderSOAP|CSenderMLLP|CSenderFileSystem|CSenderHTTP show|0';
        ...
        $props['define_name']                       = 'enum list|name|datefile_category|datefile_name|timestamp_datefile_category default|name';
        ...
        $props['check_identifiers']                 = 'bool default|1';
        $props['type_sas']                          = 'enum list|lifen|sisra';
        $props['unqualified_identity']              = 'bool default|0';
        $props['handle_SIU_object']                 = 'enum list|consultation|intervention default|consultation';
