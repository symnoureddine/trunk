...
class CSetupHl7 extends CSetup {
  ...
  function __construct() {
    ...
    $this->addDefaultConfig("hl7 CHL7 assigning_authority_universal_type_id", "hl7 assigning_authority_universal_type_id");
    ...
    $this->insertTableEntry("3306", "AUCUN"  , "AUCUN"  , "aucun"  , "aucun"  , "Sans prise en charge médicalisée ou para médicalisée");
