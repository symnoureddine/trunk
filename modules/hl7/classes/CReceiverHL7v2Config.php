...
class CReceiverHL7v2Config extends CMbObjectConfig
{
    ...
    function getProps()
    {
        ...
        // Version
        $props['HL7_version']       = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['ITI30_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7|FRA_2.3|FRA_2.4|FRA_2.5|FRA_2.6|FRA_2.7|FRA_2.8|FRA_2.9 default|2.5';
        $props['ITI31_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7|FRA_2.3|FRA_2.4|FRA_2.5|FRA_2.6|FRA_2.7|FRA_2.8|FRA_2.9 default|2.5';
        $props['RAD3_HL7_version']  = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['RAD28_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['RAD48_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['ITI9_HL7_version']  = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['ITI21_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
        $props['ITI22_HL7_version'] = 'enum list|2.1|2.2|2.3|2.3.1|2.4|2.5|2.5.1|2.6|2.7 default|2.5';
