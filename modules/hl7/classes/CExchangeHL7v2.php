...
class CExchangeHL7v2 extends CExchangeTabular {
  ...
  function understand($data, CInteropActor $actor = null) {
    ...
    if ($hl7_message_evt == "CHL7EventACK") {
      $this->_family_message_class = "CHL7EventACK";
      $this->_family_message       = CHL7Event::getEventVersion($hl7_message->version, "ACK");
      return true;
    }
  ...
  function getMessage() {
    ...
    function getMessageInitial() {
        $content_tabular = $this->loadFwdRef("message_content_id", true);
