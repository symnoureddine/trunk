  ...
  lockCodages = function(praticien_id, codable_class, codable_id, date) {
    ...
    {{else}}
      url.requestUpdate('systemMsg', {
        ...
        method: 'post',
        getParameters: {m: 'ccam',a: 'ajax_lock_codage'}
      });
    {{/if}}
  };
...
{{if 'dPccam codage allow_ccam_cotation_sejour'|gconf && !$subject->_coded}}
  ...
  {{/if}}
    <tr>
      ...
      <td class="halfPane">
        <fieldset id="didac_inc_manage_codes_fieldset_code" class="me-no-align me-no-box-shadow">
      ...
      <tr>
        <td>
          <fieldset>
            ...
            {{if $conf.dPsalleOp.CActeCCAM.envoi_actes_salle || $m == "dPpmsi"}}
