...
<script>
  ...
  togglePrintZone = function (name, sejour_id) {
    ...
    var tables = ["print_forms", "print_tasks", "print_prescription", "print_constante", "print_sejour", "print_patient"];
    ...
    <td style="vertical-align: middle;" class="button">
      ...
      <form name="filterPrint" method="get" style="clear:both;float: left;">
        ...
        <label><input type="checkbox" name="print_patient" checked
                      onclick="togglePrintZone('print_patient', '{{$sejour->_id}}');"/> {{tr}}CPatient{{/tr}}</label>
        ...
        <label><input type="checkbox" name="print_transmission" checked
                      onclick="togglePrintZone('print_transmission', '{{$sejour->_id}}');"/> Transmissions</label>
        <label><input type="checkbox" name="print_observation" checked
                      onclick="togglePrintZone('print_observation', '{{$sejour->_id}}');"/> Observations</label>
        ...
        <div class="loading" style="height: 16px; display: none;" id="forms-loading-{{$sejour->_id}}">Chargement des
      ...
      <div style="clear:both;">
        <a class="button print" onclick="printDossierFromSejour({{$sejour->_id}})">{{tr}}Print{{/tr}}</a>
...
{{if "monitoringPatient"|module_active && "monitoringBloc"|module_active && "monitoringBloc general active_graph_supervision"|gconf}}
<div id="surveillance_perop_{{$sejour->_id}}" class="tab_soins" style="display: none; page-break-after: always;">
