...
<form name="editObjectif" method="post" onsubmit="onSubmitFormAjax(this, Control.Modal.close);">
  ...
  <table class="form">
    ...
    <tr>
      ...
      <td>{{mb_field object=$objectif_soin field=libelle}}</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="text">{{mb_field object=$objectif_soin field=intervenants}}</td>
    </tr>
    <tr>
      <th>{{mb_label object=$objectif_soin field=moyens}}</th>
      <td class="text">{{mb_field object=$objectif_soin field=moyens}}</td>
    </tr>
    <tr>
      <th></th>
    </tr>
    <tr>
      ...
      <td class="text">{{mb_field object=$objectif_soin field=commentaire}}</td>
    </tr>
    <tr>
