...
<script>
  showScores = function() {
    ...
    url.requestModal('90%', '95%', {onClose: function() {
  ...
  <tr>
    <td style="width: 33%;">
      <fieldset class="me-fieldset-tran me-fieldset-widget">
        <legend>
          <button class="search notext compact me-tertiary" type="button" onclick="Soins.showModalAllTrans('{{$sejour->_id}}')"></button>
        ...
        <fieldset class="me-fieldset-widget">
          <legend>
            ...
            <button id="form-scores-digest" class="fa fa-list-alt compact" onclick="showScores();">
              IGS : &ndash; / Chung : &ndash;
            </button>
          </legend>
          <div id="{{$unique_id_widget_forms}}" class="me-fieldset-content" style="height: 140px; overflow-y: auto;"></div>
        </fieldset>
      </td>
    {{/if}}
    ...
    <td style="width: 33%;">
      <fieldset class="me-fieldset-widget">
        <legend>
          <button class="search notext compact me-tertiary" type="button" onclick="Soins.openSurveillanceTab();"></button>
          Surveillance
        </legend>
