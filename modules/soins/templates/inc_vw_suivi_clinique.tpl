...
<table class="main" style="text-align: left; width: 100%">
  <tr>
            ...
            <td>
              ...
              {{else}}
                <button type="button" class="tick me-tertiary"
                        onclick="Admissions.validerEntree('{{$sejour->_id}}', null, afterEditCorrespondant);">{{tr}}CSejour-action-Validate the entry{{/tr}}</button>
              {{/if}}
            </td>
            <td>
    ...
    <td style="vertical-align: top;" rowspan="2">
      ...
      {{if "dPpmsi"|module_active && "atih"|module_active && "atih CGroupage use_fg"|gconf && $sejour->type !== "ambu" && !in_array($sejour->type, 'Ox\Mediboard\PlanningOp\CSejour::getTypesSejoursUrgence'|static_call:null)}}
        <table class="tbl me-table-card">
          <tr>
            <th class="title" colspan="2">
