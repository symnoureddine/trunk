...
class CBlocOperatoire extends CMbObject {
  /** @var string */
  public const RESOURCE_NAME = 'bloc';
  ...
  public function getApiLink(): string {
    return CRouter::getInstance()
      ->generate('bloc_bloc', ["bloc_operatoire_id" => $this->_id]);
  }
   ...
   * @return CSalle[]
   */
  function loadRefsSalles($where = array()) {
    return $this->_ref_salles = $this->loadBackRefs("salles", "nom", null, null, null, null, "", $where);
  }
