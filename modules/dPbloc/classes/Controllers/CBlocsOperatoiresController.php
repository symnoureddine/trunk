...
class CBlocsOperatoiresController extends CController {
   ...
   * @api
   */
  public function listBlocs(CRequestApi $request_api): Response {
    ...
    $resource = CCollection::createFromRequest($request_api, $blocs);
   ...
   * @api
   */
  public function showBloc(CRequestApi $request_api, CBlocOperatoire $bloc):Response {
    return $this->renderApiResponse(CItem::createFromRequest($request_api, $bloc));
  }
   ...
   * @api
   */
  public function listBlocsWithPlages(CRequestApi $request_api): Response {
