...
class CPlagesOpsController extends CController
{
     ...
     * @api
     */
    public function listPlages(CRequestApi $request_api): Response
    {
        ...
        $resource = CCollection::createFromRequest($request_api, $plages);
     ...
     * @api
     */
    public function showPlage(CRequestApi $request_api, CPlageOp $plage): Response
    {
        $this->formatPlage($plage);

        return $this->renderApiResponse(CItem::createFromRequest($request_api, $plage));
    }
