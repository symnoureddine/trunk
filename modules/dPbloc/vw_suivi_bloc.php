...
foreach ($operations as $_key => $_op) {
  ...
  elseif (!$_op->entree_salle && $brancardage && $brancardage->_id && ($brancardage->_ref_first_item->demande_brancard || $brancardage->_ref_first_item->prise_en_charge || $brancardage->_ref_first_item->patient_pret)) {
    $type_op = "brancardage";
  }
