...
<div id="offline" style="display: none;">
  <table class="tbl">
    <tr>
      <td>
        <a class="button search" target="_blank" href="?m=bloc&dialog=view_planning&g={{$g}}&offline=1">
    ...
    <tr>
      <td>
        <a class="button search" target="_blank" href="?m=bloc&dialog=view_planning&g={{$g}}&offline=1&_by_bloc=1&_page_break=1">
    ...
    <tr>
      <td>
        <a class="button search" target="_blank" href="?m=bloc&dialog=offline_preparation_salle&g={{$g}}">
