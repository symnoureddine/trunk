      ...
      <table style="width:100%;">
        ...
        <tr>
          <td>
            ...
            :{{if $blood_salvage->receive_kit_ref}} Ref n° {{$blood_salvage->receive_kit_ref}} {{/if}}
            {{tr}}CBloodSalvage-receive_kit_lot{{/tr}}
            :{{if $blood_salvage->receive_kit_lot}} Lot n° {{$blood_salvage->receive_kit_lot}} {{/if}} <br />
            {{tr}}CBloodSalvage-wash_kit_ref{{/tr}}:{{if $blood_salvage->wash_kit_ref}} Ref n° {{$blood_salvage->wash_kit_ref}} {{/if}}
            {{tr}}CBloodSalvage-wash_kit_lot{{/tr}}:{{if $blood_salvage->wash_kit_lot}} Lot n° {{$blood_salvage->wash_kit_lot}} {{/if}}
            <br />
      ...
      <table style="width:100%;">
        ...
        <tr>
          <td>
            ...
            {{mb_label object=$blood_salvage field=hgb_patient}} : {{mb_value object=$blood_salvage field=hgb_patient}} g/dl<br />
            <br />
            {{mb_label object=$blood_salvage field=transfused_volume}} : {{mb_value object=$blood_salvage field=transfused_volume}}
            ml<br />
  ...
  <tr>
    <td>
      <table style="width:100%;">
        ...
        <tr>
          <td>
            {{if $blood_salvage->type_ei_id}} {{tr}}CTypeEi-type_ei_id-desc{{/tr}} : {{$blood_salvage->_ref_incident_type->_view}} {{else}} Aucun incident transfusionnel {{/if}}
            <br />
