...
if ($see_sorties) {
  ...
  $ljoin["patient_handicap"] = "patients.patient_id = patient_handicap.patient_id";
  ...
  $where[] = "(operations.date BETWEEN '$filter->_date_min_stat' AND '$filter->_date_max_stat')
    OR (plagesop.date BETWEEN '$filter->_date_min_stat' AND '$filter->_date_max_stat')";
  ...
  $order = "patients.nom ASC, patients.prenom ASC, sejour.sortie_prevue";
