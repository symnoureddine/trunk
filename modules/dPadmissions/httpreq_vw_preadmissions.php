...
foreach ($listConsultations as $_consult) {
  ...
  $_consult->loadRefPatient()->updateBMRBHReStatus();
...
if ($sejour_prepared) {
  ...
  if ($order_col_pre == "patient_id") {
    array_multisort(CMbArray::pluck($listConsultations, "_ref_patient", "nom"), $order_way_pre == "ASC" ? SORT_ASC : SORT_DESC, $listConsultations);
  }
}
