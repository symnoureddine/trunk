 ...
 * Description
 */
class ExObjectPDFConverterTest extends UnitTestMediboard
{
    /** @var string */
    ...
    private function getExObject(): CExObject
    {
        ...
        $ex_object->group_id     = $this->getRandomObjects(CGroups::class, 1)->_id;
    ...
    private function getObject(): CMbObject
    {
        ...
        return $object = $this->getRandomObjects(CSejour::class, 1);
    }
