...
{{if !$form_name}}
    ...
    <i id="icon-{{$form_uid}}"
       class="fa fa-list event-icon small_ambu small_pointer" style="display: none;background-color: {{if ($object->_class == 'CSejour' || $object->_class == 'COperation') && $object->_completeness_color_form}}{{$object->_completeness_color_form}}{{else}}grey{{/if}};"
