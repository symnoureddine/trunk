...
class CSetupStock extends CSetup {
  ...
  function __construct() {
    ...
    $this->addDefaultConfig("dPstock CProductStock allow_quantity_fractions", "dPstock CProductStock allow_quantity_fractions");
    $this->addDefaultConfig("dPstock CProductStockGroup infinite_quantity", "dPstock CProductStockGroup infinite_quantity");
    $this->addDefaultConfig("dPstock CProductStockGroup pagination_size", "dPstock CProductStockGroup pagination_size");
    $this->addDefaultConfig("dPstock CProductStockGroup negative_allowed", "dPstock CProductStockGroup negative_allowed");
    $this->addDefaultConfig("dPstock CProductStockService infinite_quantity", "dPstock CProductStockService infinite_quantity");
    $this->addDefaultConfig("dPstock CProductStockService pagination_size", "dPstock CProductStockService pagination_size");
    $this->addDefaultConfig("dPstock CProductReference show_cond_price", "dPstock CProductReference show_cond_price");
    $this->addDefaultConfig("dPstock CProductReference pagination_size", "dPstock CProductReference pagination_size");
    ...
    $this->addDefaultConfig("dPstock CProductDelivery auto_dispensation", "dPstock CProductDelivery auto_dispensation");
