    ...
    case CProduct::class:
      ...
      foreach ($products as $_product) {
        ...
        if ($denominateur) {
          ...
          mbTrace($produit->ucd_view);
          mbTrace($unite_delivrance, "unite délivrance");
          mbTrace($libelle_presentation, "libelle presentaion");
          mbTrace($libelle_unite_de_presentation, "libelle unite presentation");
        }
      }

      mbTrace($count . "/" . count($products) . " produits dont l'unite de délivrance est dans les up");
