...
<form name="import-mediusers" method="post" onsubmit="return onSubmitFormAjax(this, null, 'result-import-mediusers');">
  ...
  <table class="main form">
    ...
    <tr>
      ...
      <td colspan="3">
        <input type="text" size="50" name="directory" onchange="checkDirectory(this);"/>
        <div id="directory-check"></div>
      </td>
    </tr>

    <tr>
      <th><label for="user_id">{{tr}}CMediusers-import-id{{/tr}}</label></th>
      <td colspan="3"><input type="text" name="user_id" size="5"/></td>
    </tr>
