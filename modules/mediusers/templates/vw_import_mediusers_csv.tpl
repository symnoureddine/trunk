...
<div class="big-info">
  ...
  <ol>
    ...
    <li><strong>password</strong> : Mot de passe de l'utilisateur (obligatoire uniquement pour la création d'utilisateurs)</li>
    <li>
    ...
    <li><strong>fonction</strong> ({{mb_label class=CFunctions field=text}}) : Nom de la fonction, créée si introuvable</li>
    <li>
      profil ({{mb_label class=CUser field=user_username}}) : Nom du profil à utiliser pour l'utilisateur, non créé si introuvable
    </li>
    ...
    <li>idex : Identifiants externes de l'utilisateur. Il est possible d'ajouter plusieurs identifiants externes en les séparant par ,
      (ex: 123456,987654,135790). Pour ajouter des tags à ces identifiant il faut ajouter |tag à la fin de l'identifiant (ex: 123456|ldap,526554,21156|idx)</li>
    ...
    <li>ufsecondaire : Codes des unités fonctionnelles secondaires (séparés par |). Les UF ne sont pas créées si elles n'existent pas.</li>
...
<form method="post" name="import" action="?m=mediusers&a=ajax_import_mediusers_csv" enctype="multipart/form-data" onsubmit="return onSubmitFormAjax(this, {useFormAction: true}, 'result-import');">
