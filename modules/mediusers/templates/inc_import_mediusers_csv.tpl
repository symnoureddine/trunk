...
<table class="tbl">
  ...
  {{foreach from=$results item=_user}}
    <tr>
      ...
      <td class="text {{if array_key_exists('user', $unfound) && array_key_exists($_user.nom, $unfound.user)}}warning{{/if}}">
        {{$_user.nom}}
      </td>
      ...
      <td class="text {{if array_key_exists('type', $unfound) && array_key_exists($_user.type, $unfound.user_type)}}warning{{/if}}">{{$_user.type}}</td>
      <td class="text">{{$_user.fonction}}</td>
      <td class="text {{if array_key_exists('profil', $unfound) && array_key_exists($_user.profil, $unfound.profil)}}warning{{/if}}">{{$_user.profil}}</td>
      ...
      <td class="text {{if array_key_exists('spec_cpam', $unfound) && array_key_exists($_user.spec_cpam, $unfound.spec_cpam)}}warning{{/if}}">{{$_user.spec_cpam}}</td>
      <td class="text {{if array_key_exists('discipline', $unfound) && array_key_exists($_user.discipline, $unfound.discipline)}}warning{{/if}}">{{$_user.discipline}}</td>
      <td class="text {{if array_key_exists('idex', $unfound) && array_key_exists($_user.idex, $unfound.idex)}}warning{{/if}}">{{$_user.idex}}</td>
      ...
      <td class="text">{{if array_key_exists('num_astreinte_autre', $_user)}}{{$_user.num_astreinte_autre}}{{/if}}</td>
