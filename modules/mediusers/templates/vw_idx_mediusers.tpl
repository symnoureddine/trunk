...
{{mb_script module=mediusers script=CMediuserFunctions ajax=1}}
...
<script>
  ...
  searchMedecinAnnuaire = function(user_id) {
...
<div style="padding-bottom: 5px" class="me-margin-top-4 me-padding-left-8">
  ...
  {{if 'Ox\Core\CAppUI::conf'|static_call:'dPpatients CPatient function_distinct'}}
    <button class="new" type="button" onclick="searchMedecinAnnuaire();">
