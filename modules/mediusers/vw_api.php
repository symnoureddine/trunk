...
$api = array(
  ...
  'api_create_user'    => array(
    ...
    'form'   => array(
      ...
      'facuration_electronique' => CAPITools::makeAPIfield('bool'),
      'specialite_tarmed'       => CAPITools::makeAPIfield('text'),
      'role_tarmed'             => CAPITools::makeAPIfield('text'),
      'place_tarmed'            => CAPITools::makeAPIfield('text'),
