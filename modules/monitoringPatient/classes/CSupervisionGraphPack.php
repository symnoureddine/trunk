...
class CSupervisionGraphPack extends CMbObject {
  ...
  static $_operation_timing_fields = array(
    "debut_prepa_preop", "fin_prepa_preop", "entree_salle", "sortie_salle",
    "remise_chir", "tto", "pose_garrot", "prep_cutanee",
    "debut_op", "fin_op", "retrait_garrot", "entree_reveil",
    "sortie_reveil_possible", "sortie_reveil_reel", "induction_debut",
    "induction_fin", "suture_fin", "entree_bloc", "cleaning_start",
    "cleaning_end", "installation_start", "installation_end", "incision",
  );
  ...
  function getTimingFields() {
    if (!$this->timing_fields) {
      return $this->_timing_fields = array();
    }
