...
{
    private const EXTERNAL_CLASS = 'CSLT';
    ...
    public function getDefaultRefEntities(): array
    {
        if ($this->default_refs) {
            $refs = [
                ...
                ExternalReference::getMandatoryFor('plage_consultation', $this->plageconsult_id),
            ];
        } else {
    ...
    public function getAlternateRefEntities(): array
    {
        return [
            ExternalReference::getMandatoryFor('patient', $this->patient_id),
            ExternalReference::getMandatoryFor('plage_consultation_autre', $this->plageconsult_id),
        ];
    }
