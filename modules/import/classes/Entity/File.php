...
class File extends AbstractEntity
{
    ...
    {
        return [
            ExternalReference::getNotMandatoryFor('utilisateur', $this->author_id),
            ExternalReference::getNotMandatoryFor('patient', $this->patient_id),
            ExternalReference::getNotMandatoryFor(
                $this->default_refs ? 'consultation' : 'consultation_autre',
                $this->consultation_id
            ),
            ExternalReference::getNotMandatoryFor('sejour', $this->sejour_id),
            ExternalReference::getNotMandatoryFor('evenement_patient', $this->evenement_id),
        ];
    }
