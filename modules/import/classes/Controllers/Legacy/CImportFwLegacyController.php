...
use Ox\Core\CView;
use Ox\Import\Axisante\CAxisanteImport;
...
abstract class CImportFwLegacyController extends CLegacyController
{
    ...
    public function ajax_vw_import_fw(): void
    {
        ...
        $this->renderSmarty(
            ...
            [
                ...
                'last_id'    => ($last_id) ?: 0,
                'module'     => $this->getModName(),
                'by_patient' => $this->isImportByPatient(),
            ],
            'modules/import'
        );
    }
    ...
    abstract protected function getImportInstance(): CFwImport;

    protected function isImportBypatient(): bool
    {
        return true;
    }
