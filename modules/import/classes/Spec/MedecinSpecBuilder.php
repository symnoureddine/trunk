...
class MedecinSpecBuilder
{
    ...
    private const CONF_STRICT = 'dPpatients CMedecin medecin_strict';
    ...
    private function buildSpec(string $spec_name): ?SpecificationInterface
    {
        switch ($spec_name) {
            ...
            case self::FIELD_TEL_AUTRE:
                if (CAppUI::gconf(self::CONF_STRICT)) {
                    return $this->getTelSpec($spec_name, true);
                } else {
            ...
            case self::FIELD_CP:
                if (CAppUI::gconf(self::CONF_STRICT)) {
                    return $this->getCpSpec($spec_name, true);
                }
    ...
    {
        return (CAppUI::gconf(self::CONF_STRICT)) ? NotNull::is(self::FIELD_ADRESSE) : null;
    }
