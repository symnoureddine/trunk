...
class SejourSpecBuilder
{
    ...
    private const FIELD_GROUP_ID      = 'group_id';
    ...
    public function build(): ?SpecificationInterface
    {
        $spec_to_add = [
            ...
            $this->buildSpec(self::FIELD_GROUP_ID),
    ...
    {
        $debut_entree_prevu  = new DateTime("2020-12-12 12:12:12");
        $debut_entree_reelle = new DateTime("2020-12-12 12:12:12");
        ...
        $spec  = new OrX(
            ...
            new AndX(
                ...
                GreaterThan::is(self::FIELD_SORTIE_REELLE, $debut_entree_reelle)
            )
        );
        $specs[] = $spec;
        $spec    = new AndX(
            ...
            GreaterThan::is(self::FIELD_SORTIE_PREVUE, ($debut_entree_prevu))
        );
        $specs[] = $spec;
