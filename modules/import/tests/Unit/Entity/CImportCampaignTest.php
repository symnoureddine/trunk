...
class CImportCampaignTest extends UnitTestMediboard
{
    ...
    {
        $medi_user = $this->getRandomObjects(CMediusers::class);
    ...
    public function testClose(): void
    {
        ...
        $this->assertMatchesRegularExpression("/\d{4}\-\d{2}\-\d{2}\s\d{2}:\d{2}:\d{2}/", $c_import_campaign->closing_date);
    }
