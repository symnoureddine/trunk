...
Document = (window.Document && window.Document.create) ? window.Document : {
  ...
  del: function(form, doc_view) {
    ...
    var oAjaxOptions = Document.refreshList.curry($V(form.file_category_id), $V(form.object_class), $V(form.object_id));
