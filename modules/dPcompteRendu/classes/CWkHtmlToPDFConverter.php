...
class CWkHtmlToPDFConverter extends CHtmlToPDFConverter {
   ...
   */
  function render() {
    $bin = CWkhtmlToPDF::getExecutable();
    ...
    if ($return_code !== 0) {
      CApp::log("WkHtmlToPDF error " . $return_code, null, CLogger::LEVEL_DEBUG);
    }
    ...
    foreach ($files as $_file) {
      try {
        ...
        CApp::log("Failed to delete file $_file : " . $e->getMessage(), null, CLogger::LEVEL_INFO);
      }
    }
  }
