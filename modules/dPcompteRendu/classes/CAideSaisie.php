...
class CAideSaisie extends CMbObject {
    ...
    /** @var string  */
    public const RESOURCE_NAME = "input_help";
  ...
  function loadRefsCodesSnomedConceptMap() {
     ...
     */
    public function getResourceUser(): ?CItem
    {
        ...
        $res = new CItem($user);
        $res->setName(CMediusers::RESOURCE_NAME);
    ...
    public function getResourceFunction(): ?CItem
    {
        ...
        $res = new CItem($function);
        $res->setName(CFunctions::RESOURCE_NAME);
    ...
    public function getResourceGroup(): ?CItem
    {
        ...
        $res = new CItem($group);
        $res->setName(CGroups::RESOURCE_NAME);
