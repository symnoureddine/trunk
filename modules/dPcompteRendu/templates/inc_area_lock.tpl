  ...
  <fieldset>
    <form name="LockDocOwner" method="post">
      <table class="form">
        ...
        <tr>
          <td class="button">
            <button type="button" class="tick" onclick="toggleLock('{{$app->user_id}}', 'LockDocOwner')">{{tr}}Lock{{/tr}}</button>
          </td>
        </tr>
      </table>
    </form>
      ...
      <table class="form">
        ...
        <tr>
          <td class="button" colspan="2">
            <button class="tick singleclick" onclick="return this.form.onsubmit();">{{tr}}Lock{{/tr}}</button>
          </td>
        </tr>
      </table>
    </form>
