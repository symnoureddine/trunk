...
CKEDITOR.editorConfig = function(config) {
  ...
  {{if $templateManager->printMode}}
    config.toolbar = [['Preview' {{if $app->user_prefs.show_old_print}},'Print'{{/if}} {{if $app->user_prefs.pdf_and_thumbs}},'mbprintPDF'{{/if}}, '-','Find', 'usermessage']];
