...
class CTypeAnesthController extends CController {
   ...
   * @api
   */
  public function listTypesAnesth(CRequestApi $request_api): Response {
    ...
    $resource = CCollection::createFromRequest($request_api, $types_anesth);
   ...
   * @api
   */
  public function showTypeAnesth(CRequestApi $request_api, CTypeAnesth $type_anesth): Response {
    return $this->renderApiResponse(CItem::createFromRequest($request_api, $type_anesth));
  }
}