...
class DHEsController extends CController
{
     ...
     * @api
     */
    public function addDHE(CRequestApi $request_api, COperation $intervention = null, CSejour $sejour = null): Response
    {
        ...
        $intervention->presence_preop  = isset($fields["intervention_preop"]) ? $fields["intervention_preop"] : "";
        $intervention->presence_postop = isset($fields["intervention_postop"]) ? $fields["intervention_postop"] : "";
        ...
        $resource = CItem::createFromRequest($request_api, $intervention);
     ...
     * @api
     */
    public function modifyDHE(CRequestApi $request_api, COperation $operation): Response
    {
     ...
     * @api
     */
    public function showDHE(CRequestApi $request_api, COperation $operation): Response
    {
        return $this->renderApiResponse(CItem::createFromRequest($request_api, $operation));
    }
