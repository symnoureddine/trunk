...
class CProtocole extends CMbObject {
  ...
  public function getApiLink(): string {
    return CRouter::getInstance()
      ->generate('planning_protocole', ["protocole_id" => $this->_id]);
  }
  ...
  function getProps() {
    ...
    $props["uf_soins_id"]         = "ref class|CUniteFonctionnelle seekable back|protocoles_soin";
    ...
    $props["type_anesth"]         = "ref class|CTypeAnesth back|protocole";
    ...
    $props['time_entree_prevue']  = 'time';
    $props["circuit_ambu"]        = "enum list|court|moyen|long";
    $props["admission"]           = "enum list|veille|jour";
  ...
  static function computeMedian($protocoles = array()) {
    ...
    array_multisort(CMbArray::pluck($protocoles, "_temps_median"), SORT_DESC, $protocoles);
    return $protocoles;
  }
