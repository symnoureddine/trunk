...
use Ox\Mediboard\Compendium\CCompendiumArticle;
...
class CMaterielOperatoire extends CMbObject {
  ...
  public function getSpec() {
    ...
    $spec->xor["elt"]   = array("dm_id", "code_cip");
    return $spec;
  }
   ...
   *
   * @return CBcbProduit|CBescoArticle|CCompendiumArticle|CVidalArticle
   */
  ...
  /**
   * Récupère les lots disponibles pour un dm donné
   *
   */
  public function loadAvailableLots() {
    if (!$this->dm_id) {
      return;
    }
   ...
   */
  public static function getList($context, $with_refs = false, $only_missing = false, $separate_sterilisable = false) {
    $where = [];
