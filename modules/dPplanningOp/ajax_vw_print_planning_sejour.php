...
foreach ($lines as $category => $cat) {
  foreach ($cat as $_line) {
    ...
    array_multisort(CMbArray::pluck($_line->_ref_administrations, "dateTime"), SORT_DESC, $_line->_ref_administrations);
    ...
    array_multisort(CMbArray::pluck($planifs, "dateTime"), SORT_DESC, $planifs);
