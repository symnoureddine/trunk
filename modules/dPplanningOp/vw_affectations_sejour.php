...
if (!CAppUI::conf("soins UserSejour see_global_users", $group)) {
  ...
  array_multisort(CMbArray::pluck($sejour->_ref_users_sejour, "debut"), SORT_DESC,
    CMbArray::pluck($sejour->_ref_users_sejour, "_ref_user", "_user_last_name"), SORT_ASC, $sejour->_ref_users_sejour);
}
