...
ProtocoleOp = window.ProtocoleOp || {
  ...
  editMateriel: function (materiel_operatoire_id, protocole_operatoire_id) {
    new Url('planningOp', 'ajax_edit_materiel_op')
  ...
  delConsommationMateriel: function (consommation_materiel_id, materiel_operatoire_id) {
    ...
    return onSubmitFormAjax(form, function () {
      ...
      ProtocoleOp.refreshConsommations(materiel_operatoire_id);
    });
  },
  ...
  refreshConsommations: function (materiel_operatoire_id) {
    new Url('planningOp', 'ajax_list_consommations')
      .addParam('materiel_operatoire_id', materiel_operatoire_id)
      .requestUpdate('consommations_area_' + materiel_operatoire_id);
  },
