...
ProtocoleDHE = window.ProtocoleDHE || {
  ...
  refreshListCCAMProtocole: function () {
    ...
    if ($V(oForm.codes_ccam) != '' && $V(oForm.facturation_rapide)) {
  ...
  toggleCodageButton: function () {
    $('codage_button').toggle();
  },
  ...
  updateListCPI: function (form, showOnlyChargePriceIndic) {
