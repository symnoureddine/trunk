...
<form name="applyProtocoleOp" method="post">
  ...
  <fieldset>
    ...
    <table class="tbl">
      ...
      <tr>
        <th class="section" colspan="3">{{tr}}CMaterielOperatoire-DM usage unique{{/tr}}</th>
      </tr>
      ...
      <tr>
        <th class="section" colspan="3">{{tr}}CMaterielOperatoire-code_cip{{/tr}}</th>
      </tr>
      ...
      <tr>
        <th class="section" colspan="3">{{tr}}CMaterielOperatoire-DM sterilisables{{/tr}}</th>
      </tr>
