...
<table class="form">
  ...
  <tr>
    ...
    <td>
      ...
      <div id="_adresse_par_prat"{{if $consult->adresse_par_prat_id && $patient->_ref_medecin_traitant && $consult->_ref_adresse_par_prat == $patient->_ref_medecin_traitant->_id}} style="display: none;"{{/if}}>
        {{if $consult->adresse_par_prat_id}}
          Autres : {{$consult->_ref_adresse_par_prat}}
        {{/if}}
      </div>
    </td>
  </tr>
