...
<li><strong>{{tr}}CProtocole-Export-Titre-Duree intervention{{/tr}}</strong> (<code>HH:MM</code>)</li>
...
<li><strong>{{tr}}CProtocole-Export-Titre-Duree hospitalisation{{/tr}}</strong></li>
<li>{{tr}}CProtocole-Export-Titre-Duree uscpo{{/tr}}</li>
<li>{{tr}}CProtocole-Export-Titre-Durée preop{{/tr}} (<code>HH:MM</code>)</li>
...
<li><strong>{{tr}}CProtocole-Export-Titre-Facturable{{/tr}}</strong> (<code>0</code> pour un protocole non facturable, <code>1</code> pour un protocole facturable)</li>
...
{{if $results|@count}}
  ...
  <table class="tbl">
    <tr>
      <th class="title" colspan={{math equation=x+y x=42 y=$idex_names|@count}}>{{$results|@count}} protocoles trouvés</th>
    </tr>
    <tr>
      <th>Etat</th>
