...
<table class="main">
  {{if $sejour->_id && !$dialog}}
    <tr>
      <td colspan="2">
        <a id="didac_program_new_sejour" class="button new me-primary" href="?m={{$m}}&tab={{$tab}}&sejour_id=0">
  ...
  <tr>
    ...
    <td>
      {{if $m != "reservation" && $sejour->_id}}
        <a class="button new me-primary" href="?m={{$m}}&tab=vw_edit_planning&operation_id=0&sejour_id={{$sejour->_id}}" id="link_operation" target="_parent">
      ...
      <table class="form" style="width: 100%;">
        <tr>
          <th class="title">
            ...
            <button type="button" class="search" style="float: right;" onclick="showLegende();">{{tr}}Legend{{/tr}}</button>
          </th>
        </tr>
        <tr>
