    ...
    {{elseif $type_examen == "rayons_x"}}
      ...
      {{else}}
        ...
        <tr>
          ...
          <td>{{mb_field object=$op field=dose_recue_graphie form=editExamen increment=true}}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>{{mb_field object=$op field=dose_recue_scopie form=editExamen increment=true}}</td>
        </tr>
        <tr>
