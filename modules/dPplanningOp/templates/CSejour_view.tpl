...
<table class="tbl tooltip">
  ...
  <tr>
    <td class="button">
      ...
      {{if "speedCall"|module_active && "speedCall Global contextual"|gconf && $modules.speedCall->_can->edit}}
      ...
      <div class='me-dropdown-button me-dropdown-button-right'>
        ...
        <div class='me-dropdown-content'>
          ...
          {{if "synedra"|module_active}}
            {{mb_include module=synedra template=inc_button_synedra notext="" _sejour=$sejour}}
          {{/if}}
