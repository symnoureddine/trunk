...
{{assign var=use_remise_chir    value=$conf.dPsalleOp.COperation.use_remise_chir}}
{{assign var=use_garrot         value=$conf.dPsalleOp.COperation.use_garrot}}
{{assign var=use_debut_fin_op   value=$conf.dPsalleOp.COperation.use_debut_fin_op}}
