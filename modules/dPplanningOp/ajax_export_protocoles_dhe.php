...
if ($chir->_id || $function_id) {
    ...
    array_multisort(
        CMbArray::pluck($protocoles_func, "_ref_function", "text"),
        SORT_ASC,
        array_map("strtolower", CMbArray::pluck($protocoles_func, "libelle")),
        SORT_ASC,
        array_map("strtolower", CMbArray::pluck($protocoles_func, "libelle_sejour")),
        SORT_ASC,
        $protocoles_func
    );
    ...
    array_multisort(
        CMbArray::pluck($protocoles_chir, "_ref_chir", "_view"),
        SORT_ASC,
        array_map("strtolower", CMbArray::pluck($protocoles_chir, "libelle")),
        SORT_ASC,
        array_map("strtolower", CMbArray::pluck($protocoles_chir, "libelle_sejour")),
        SORT_ASC,
        $protocoles_chir
    );
...
$line = [
    ...
    CAppUI::tr("CProtocole-Export-Titre-Durée preop"),
