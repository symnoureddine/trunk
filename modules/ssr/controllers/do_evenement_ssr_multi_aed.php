...
$tarmeds              = CView::post("tarmeds", "str");
$tarmeds_quantity     = CView::post("tarmeds_quantity", "str");
$_tarmeds             = CView::post("_tarmeds", "str");
$_tarmeds_quantity     = CView::post("_tarmeds_quantity", "str");
...
$concat_prestas = array(
  ...
  "tarmed" => array(" " => $tarmeds, "_" => $_tarmeds),
);
foreach ($concat_prestas as $type_presta => $prestas_by_type) {
  foreach ($prestas_by_type as $var_type => $prestas_ssr) {
    if (is_array($prestas_ssr)) {
      if ($type_presta == "presta_ssr") {
        $quantites = $var_type == "_" ? $_prestas_ssr_quantity : $prestas_ssr_quantity;
      }
      else {
        $quantites = $var_type == "_" ? $_tarmeds_quantity : $tarmeds_quantity;
      }
