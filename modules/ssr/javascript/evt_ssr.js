...
Evt_SSR = {
  ...
  cleanCodes: function(form) {
    form.select('input.checkbox-prestas_ssr:checked', 'input.checkbox-tarmeds:checked').each(function(checkbox) {
      $V(checkbox, 0);
    });

    form.select('input.checkbox-other-prestas_ssr', 'input.checkbox-other-tarmeds').each(function(input_other) {
