...
class CActePlage extends CMbObject {
  ...
  /** @var CActiviteCsARR|CPrestaSSR|CTarmed */
  ...
  function getProps() {
    ...
    $props["type"]     = "enum list|csarr|presta|tarmed";
   ...
   *
   * @return CActiviteCsARR|CPrestaSSR|CTarmed
   */
  function getActivite() {
    ...
    return $this->_ref_activite = CTarmed::get($this->code);
  }
