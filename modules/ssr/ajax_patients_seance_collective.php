...
if ($order_col == "lit_id") {
  ...
  array_multisort($sorter, constant("SORT_$order_way"), CMbArray::pluck($sejours, "entree"), SORT_ASC, $sejours);
}
else {
  array_multisort(CMbArray::pluck($sejours, "_ref_patient", "nom"), constant("SORT_$order_way"),
    CMbArray::pluck($sejours, "_ref_patient", "prenom"), constant("SORT_$order_way"),
    CMbArray::pluck($sejours, "entree"), SORT_ASC, $sejours);
}
