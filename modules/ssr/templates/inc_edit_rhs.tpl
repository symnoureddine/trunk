        ...
        <form name="new-line-{{$rhs->_guid}}" action="?m={{$m}}" method="post" onsubmit="return CotationRHS.onSubmitLine(this);">
          ...
          <table class="form me-small-form">
            ...
            <tr>
              ...
              <td>
                {{mb_field object=$rhs_line field=code_activite_csarr class="autocomplete" onchange="CotationRHS.showModulators(this.value)"}}
            ...
            <tr>
              <th>{{mb_label object=$rhs_line field=nb_patient_seance}}</th>
              <td>{{mb_field object=$rhs_line field=nb_patient_seance}}</td>
            </tr>
            <tr>
              <th>{{mb_label object=$rhs_line field=nb_intervenant_seance}}</th>
              <td>{{mb_field object=$rhs_line field=nb_intervenant_seance}}</td>
            </tr>
            <tr>
