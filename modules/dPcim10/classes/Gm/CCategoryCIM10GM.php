...
class CCategoryCIM10GM implements IShortNameAutoloadable {
   ...
   * @param int $level The level of loading (LITE : just the code and the parent, others : The children codes and categories)
   *
   * @return CCategoryCIM10GM
   */
  public static function get($id, $level = CCodeCIM10::LITE) {
    $cache = new Cache(__METHOD__, $id, Cache::INNER_OUTER);
  ...
  public static function getChapters($level = CCodeCIM10::LITE) {
    $cache = new Cache(__METHOD__, array($level), Cache::INNER_OUTER);
