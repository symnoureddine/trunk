...
class CDRCCriterion extends CDRC {
  /** @var integer The id of the criteria */
  public $criterion_id;
  ...
  /** @var integer The display order of the criteria */
  public $order;

  /** @var integer The id of the title element */
  public $title_id;

  /** @var string The title */
  public $title;

  /** @var integer The id of the spacing element */
  public $spacing_id;

  /** @var integer The spacing (AKA level of the criteria) */
  public $spacing;

  /** @var integer The id of the ponderation element */
  ...
  /** @var boolean Indicate whether this result is valid (1) or removed (0) */
  public $validity;
