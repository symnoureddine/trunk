...
Details = {
  statOwner: function (doc_class, doc_id, owner_guid, date_min, date_max, period) {
  ...
  statPeriodicalOwner: function (doc_class, doc_id, owner_guid, category_id, object_class, target) {
