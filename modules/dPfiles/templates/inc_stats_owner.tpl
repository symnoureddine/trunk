...
<tr>
  ...
  <td>
    <button class="search notext compact me-tertiary me-dark" type="button" onclick="Details.statOwner('{{$doc_class}}', null, '{{$owner->_guid}}');">
      {{tr}}Details{{/tr}}
    </button>
    <button class="stats notext compact me-tertiary" type="button" onclick="Details.statPeriodicalOwner('{{$doc_class}}', null, '{{$owner->_guid}}');">
