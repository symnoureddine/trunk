...
<table class="tbl">
  ...
  <tr>
    ...
    <td>
      <button
        ...
        onclick="Details.statPeriodicalOwner('{{$doc->_class}}', '{{$doc->_id}}', '{{$owner_guid}}', '', '{{$_class}}');"
      >
    ...
    {{if $_details.object_class == $_class}}
      <tr class="details opacity-50" style="display: none;">
        ...
        <td>
          <button
            class="stats notext" type="button"
            onclick="Details.statPeriodicalOwner('{{$doc->_class}}', '{{$doc->_id}}', '{{$owner_guid}}', '{{$category_id}}', '{{$_class}}');"
          >
            {{tr}}Periodical details{{/tr}}
          </button>
        </td>
  ...
  <tr>
    ...
    <td>
      <button
        class="stats notext" type="button"
        onclick="Details.statPeriodicalOwner('{{$doc->_class}}', '{{$doc->_id}}', '{{$owner_guid}}', '{{$_category_id}}');"
      >
        {{tr}}Periodical details{{/tr}}
      </button>
    </td>
  ...
  <tr class="details opacity-50" style="display: none;">
    ...
    <td>
      <button
        class="stats notext" type="button"
        onclick="Details.statPeriodicalOwner('{{$doc->_class}}', '{{$doc->_id}}', '{{$owner_guid}}', '{{$_category_id}}', '{{$_details.object_class}}');"
      >
        {{tr}}Periodical details{{/tr}}
      </button>
    </td>
