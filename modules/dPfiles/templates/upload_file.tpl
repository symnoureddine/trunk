...
<form name="uploadFrm me-align-auto" action="?" enctype="multipart/form-data" method="post" onsubmit="return onSubmitFormAjax(this)">
    ...
    <tr>
      <td class="button" colspan="6">
        <div class="small-info">
          ...
          <div>{{tr}}config-dPfiles-General-extensions_yoplet  {{/tr}} : <strong>{{"dPfiles General extensions_yoplet"|gconf}}</strong></div>
        </div>
      </td>
    </tr>
