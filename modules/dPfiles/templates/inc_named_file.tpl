...
{{if "ameli"|module_active && "ameli CCerfa use_cerfa"|gconf && ($name|strpos:"signature" !== false)}}
  <div class="small-warning">
    {{tr}}CCerfa-msg-Be careful if you use Cerfas with your signature Please have a maximum resolution image of 1280 x 720 pixels{{/tr}}
  </div>
{{/if}}
