...
class CFileAddEdit extends CDoObjectAddEdit {
  ...
  function doStore() {
    ...
    if (CValue::read($this->request, "_from_yoplet") == 1) {
      /** @var CFile $obj */
      $obj = $this->_obj;
