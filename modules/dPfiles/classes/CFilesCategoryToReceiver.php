...
class CFilesCategoryToReceiver extends CStoredObject {
  ...
  function getSpec() {
    ...
    $spec->uniques["receiver_link"] = array("receiver_id", "receiver_class", "files_category_id");
    return $spec;
  }
  ...
  function getProps() {
    ...
    $props["receiver_id"]       = "ref notNull class|CInteropReceiver meta|receiver_class back|files_categories";
   ...
   */
  static function getAvailableReceivers(CDocumentItem $docItem = null, $group_id = null) {
    $receivers = array();
