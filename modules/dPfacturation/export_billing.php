...
$date_min           = CView::get('_date_min', array('date', 'default' => CMbDT::date()));
$date_max           = CView::get('_date_max', array('date', 'default' => CMbDT::date()));
...
$where = array(
  'ouverture'                   => "BETWEEN '$date_min' AND '$date_max'",
  'cloture'                     => 'IS NOT NULL',
...
$file->writeLine(
  array(
    'N° Facture', 'Nom du patient', 'N° Sécurité sociale', 'Date consultation', 'Nom du tarif', 'Montant de base', 'Montant DH',
    'Montant HT', 'Montant TVA', 'Total facturé', 'Dû patient', 'Montant réglé par le patient', 'Dû tiers', 'Dû AMO', 'Dû AMC',
    'Montant réglé par les tiers', 'Date d\'acquittement'
  )
);
