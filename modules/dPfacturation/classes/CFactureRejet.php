...
class CFactureRejet extends CMbObject {
  ...
  static function traitementDossier($chir_id) {
    ...
    $delfile_read_reject = CAppUI::gconf("dPfacturation Other delfile_read_reject");
    foreach ($files as $_file) {
      ...
      $content_file = file_get_contents($_file); 
      $rejet->readXML($content_file);
      ...
      $new_file->setContent(trim($content_file));
