...
class CFactureItem extends CMbObject {
  ...
  function getProps() {
    ...
    $specs["type"]         = "enum notNull list|CActeNGAP|CFraisDivers|CActeCCAM|CActeLPP|CActeTarmed|CActeCaisse default|CActeCCAM";
