...
class CTabsFacturation extends AbstractTabsRegister
{
    public function registerAll(): void
    {
        ...
        $view_rejects_envois = (CAppUI::conf("ref_pays") == "2" && CAppUI::gconf("dPfacturation Other see_reject_xml"));
        if ($view_rejects_envois) {
            $this->registerFile('vw_rejects_xml', TAB_READ);
            $this->registerFile('vw_envois_cdm', TAB_READ);
        }
        ...
        if (CAppUI::conf("ref_pays") == "2" && CAppUI::gconf("dPfacturation Other use_coeff_bill")) {
            $this->registerFile('vw_coeffs', TAB_READ, self::TAB_SETTINGS);
        }
