...
class CSetupFacturation extends CSetup {
  ...
  **/
  function __construct() {
    ...
    $query = "ALTER TABLE `factureitem`
                CHANGE `type` `type` ENUM ('CActeNGAP','CFraisDivers','CActeCCAM','CActeTarmed','CActeCaisse', 'CActeLPP') NOT NULL DEFAULT 'CActeCCAM';";
    $this->addQuery($query);
    ...
    $this->addDefaultConfig("dPfacturation CReglement add_pay_not_close", "dPfacturation CReglement add_pay_not_close");
    $this->addDefaultConfig("dPfacturation CReglement use_lock_acquittement", "dPfacturation CReglement use_lock_acquittement");
    $this->addDefaultConfig("dPfacturation CReglement use_mode_default", "dPfacturation CReglement use_mode_default");
    $this->addDefaultConfig("dPfacturation CReglement use_echeancier", "dPfacturation CReglement use_echeancier");
    $this->addDefaultConfig("dPfacturation CRetrocession use_retrocessions", "dPfacturation CRetrocession use_retrocessions");
    $this->addDefaultConfig("dPfacturation CFactureEtablissement use_temporary_bill", "dPfacturation CFactureEtablissement use_temporary_bill");
    $this->addDefaultConfig("dPfacturation CFactureEtablissement use_auto_cloture", "dPfacturation CFactureEtablissement use_auto_cloture");
    $this->addDefaultConfig("dPfacturation CFactureEtablissement view_bill", "dPfacturation CFactureEtablissement view_bill");
    $this->addDefaultConfig("dPfacturation CFactureCabinet use_auto_cloture", "dPfacturation CFactureCabinet use_auto_cloture");
    ...
    $this->addDefaultConfig("dPfacturation Other use_view_quantitynull", "dPfacturation Other use_view_quantitynull");
    ...
    $this->addDefaultConfig("dPfacturation CRelance nb_days_first_relance", "dPfacturation CRelance nb_days_first_relance");
    $this->addDefaultConfig("dPfacturation CRelance nb_days_second_relance", "dPfacturation CRelance nb_days_second_relance");
    $this->addDefaultConfig("dPfacturation CRelance nb_days_third_relance", "dPfacturation CRelance nb_days_third_relance");
    $this->addDefaultConfig("dPfacturation CRelance add_first_relance", "dPfacturation CRelance add_first_relance");
    $this->addDefaultConfig("dPfacturation CRelance add_second_relance", "dPfacturation CRelance add_second_relance");
    $this->addDefaultConfig("dPfacturation CRelance add_third_relance", "dPfacturation CRelance add_third_relance");
    $this->addDefaultConfig("dPfacturation CRelance nb_generate_pdf_relance", "dPfacturation CRelance nb_generate_pdf_relance");
    $this->addDefaultConfig("dPfacturation CRelance message_relance1_assur", "dPfacturation CRelance message_relance1_assur");
    $this->addDefaultConfig("dPfacturation CRelance message_relance2_assur", "dPfacturation CRelance message_relance2_assur");
    $this->addDefaultConfig("dPfacturation CRelance message_relance3_assur", "dPfacturation CRelance message_relance3_assur");
    $this->addDefaultConfig("dPfacturation CRelance message_relance1_patient", "dPfacturation CRelance message_relance1_patient");
    $this->addDefaultConfig("dPfacturation CRelance message_relance2_patient", "dPfacturation CRelance message_relance2_patient");
    $this->addDefaultConfig("dPfacturation CRelance message_relance3_patient", "dPfacturation CRelance message_relance3_patient");
    ...
    $query = "UPDATE `facture_etablissement`
                SET `regle` = '1'
                WHERE (du_patient = 0 OR patient_date_reglement IS NOT NULL) AND (du_tiers = 0 OR tiers_date_reglement IS NOT NULL);";
    $this->addQuery($query);
    $query = "UPDATE `facture_etablissement`
                SET `extourne` = '1'
                WHERE `definitive` = '1'
