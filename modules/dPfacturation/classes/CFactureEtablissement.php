...
class CFactureEtablissement extends CFacture {
  ...
  function getProps() {
    ...
    $props["diagnostic_id"] .= " back|diag_facture_etab";
    ...
    $props["compte_ch_id"]  .= " back|comptech_factu_etab";
  ...
  function updateFormFields() {
    ...
    $this->_view .= CAppUI::conf("ref_pays") == 2 ? " / $this->numero" : " / $this->num_compta";
  }
  ...
  **/
  function loadRefsReglements($cache = 1) {
    $this->_ref_reglements = $this->loadBackRefs("reglements", 'date')?: array();
  ...
  **/
  ...
  /**
   * Chargement des envois à la caisse des medecins
   *
   * @return CEnvoiCDM[]
   **/
  function loadRefsEnvoiCDM() {
    return $this->_ref_envois_cdm = $this->loadBackRefs("envois_cdm");
  }
