...
$type_aff = (CModule::getActive("tarmed") && CAppUI::gconf("tarmed CCodeTarmed use_cotation_tarmed")) ? 0 : 1;
if (!$export_csv) {
  ...
  //Titres
  $titles = array(
    CAppUI::tr("CFactureCabinet"), CAppUI::tr("CConsultation-patient_id"),CAppUI::tr('birthDate'),
    CAppUI::tr("CFactureCabinet-praticien_id"), CAppUI::tr("CConsultation-_date")
  );
  if ($filter->_etat_accident_travail != 'no') {
  ...
  if ($type_aff) {
    $titles2 = array(
      CAppUI::tr("CConsultation-secteur1"), CAppUI::tr("CConsultation-secteur2"), CAppUI::tr("CConsultation-secteur3"),
      CAppUI::tr("CConsultation-du_tva"), CAppUI::tr("CConsultation-_somme"), CAppUI::tr("CConsultation-du_patient"),
