...
<script>
  ...
  function downloadBills(facture_class) {
    var check_bill = $('check_bill');
    if (check_bill.get('count') && check_bill.get('count') != "0") {
      var oForm = getForm("printFrm");
...
{{assign var=use_cotation_tarmed value=0}}
{{if @$modules.tarmed->_can->read && 'tarmed CCodeTarmed use_cotation_tarmed'|gconf}}
  {{assign var=use_cotation_tarmed value=1}}
  ...
  <table class="main form me-no-align me-no-box-shadow">
    {{if "dPfacturation CFactureCabinet view_bill"|gconf}}
      ...
      <tr>
        <td colspan="2" class="button" style="width:50%;">
          ...
          <button class="download notext me-tertiary" type="button" onclick="changeLink(document.printFrm, 'print_noncote', null, true);">
            {{tr}}Gestion.print_noncote{{/tr}}
          </button>
        ...
        <td colspan="2" class="button">
          ...
          <button class="download notext me-tertiary" type="button" onclick="changeLink(document.printFrm, 'print_retrocession', null, true);">
            {{tr}}Gestion.print_retrocession{{/tr}}
          </button>
          <div class="small-info" style="text-align:center;">
      ...
      <tr>
        <td colspan="2" class="button" style="width:50%;">
          <button class="print" type="button" onclick="changeLink(document.printFrm, 'vw_consultations_non_facture');">
      ...
      <tr>
        <td class="button" colspan="2">
          ...
          <button class="download notext me-tertiary" type="button" onclick="changeLink(this.form, 'print_rapport', null, true);">
            {{tr}}Compta.valid_money{{/tr}}
          </button>
          {{if "dPccam codage use_cotation_ccam"|gconf}}
            <button class="download me-tertiary" type="button" onclick="exportBilling(this.form);">{{tr}}Export{{/tr}}</button>
          {{/if}}
        </td>
        <td>
          <button class="download notext me-tertiary" type="button" onclick="changeLink(this.form, 'print_compta', null, true);" style="float:right;">
            {{tr}}Compta.print{{/tr}}
          </button>
          <button class="print" type="button" onclick="changeLink(this.form, 'print_compta');" style="float:right;">
            {{tr}}Compta.print{{/tr}}
          </button>
        </td>
        <td>
          <button class="print" type="button" onclick="changeLink(this.form, 'print_bordereau');" style="float:left;">
      ...
      {{if "dPccam codage use_cotation_ccam"|gconf}}
        ...
        <tr>
          <td colspan="2" class="button">
            <button class="print" type="button" onclick="changeLink(this.form, 'print_tva');">{{tr}}Gestion.print_tva{{/tr}}</button>
          </td>
          <td colspan="2" class="button">
            <button type="button" class="print" onclick="printRatioOptam(this.form);">{{tr}}Gestion.print_ratios_optam{{/tr}}</button>
      ...
      {{if $conf.ref_pays == 2}}
        <tr>
          <td colspan="2" class="button" >
            <button class="print" type="button" onclick="changeLink(this.form, 'vw_compta_consults');">
              {{tr}}Gestion.compta_consults{{/tr}}
            </button>
          </td>
          <td colspan="2"></td>
        </tr>
        <tr>
          <td colspan="2">
            <div class="small-info" style="text-align:center;">{{tr}}Gestion.compta_consults.desc{{/tr}}</div>
          </td>
          <td colspan="2"></td>
        </tr>
      {{/if}}
      {{if $use_cotation_tarmed}}
        <tr>
          <td class="button" colspan="4">
            <hr />
          </td>
        ...
        <tr>
          <td class="button" colspan="2">
            <button type="button" onclick="Facture.importV11('CFactureCabinet');" class="hslip">
              {{tr}}Gestion.import_v11{{/tr}}
            </button>
            <button type="button" onclick="Facture.importCamt054('CFactureCabinet');" class="hslip">
              {{tr}}Gestion.importCamt054{{/tr}}
            </button>
          </td>
          <td colspan="2" class="text">
            <div class="small-info" id="response_send_bill">
              {{tr}}Gestion.import_v11.desc{{/tr}}
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="button" colspan="2">
            <button type="button" class="print" onclick="Facture.printGestion('bvr', 'CFactureCabinet', document.printFrm, 1);">
              {{tr}}BVR.print{{/tr}}
            </button>
            <button type="button" class="print"
                    onclick="Facture.printGestion('justificatif', 'CFactureCabinet', document.printFrm, 1);">
              {{tr}}Justif.print{{/tr}}
            </button>
          </td>
          <td colspan="2" rowspan="2" class="text button">
            <div class="small-info" id="response_send_bill">
              {{tr}}BVR.print.desc{{/tr}}
            </div>
            <button type="button" class="pdf" onclick="Facture.printGestion('bvr', 'CFactureCabinet', document.printFrm, 0);">
              {{tr}}BVR.view{{/tr}}
            </button>
            <button type="button" class="pdf" onclick="Facture.printGestion('justificatif', 'CFactureCabinet', document.printFrm, 0);">
              {{tr}}Justif.view{{/tr}}
            </button>
          </td>
        </tr>
        <tr>
          <td class="button" colspan="2">
            <button type="button" class="send" onclick="checkBills('CFactureCabinet');">{{tr}}Generate_xml.Tarmed{{/tr}}</button>
          </td>
        </tr>
      {{/if}}
    {{/if}}
    {{if "dPfacturation CFactureEtablissement view_bill"|gconf}}
      ...
      <tr>
        <td class="button" colspan="2">
          {{if $conf.ref_pays == 1}}
            <button type="button" class="print" onclick="viewActes();">{{tr}}Compta.valid_money{{/tr}}</button>
            <button type="button" class="download notext" onclick="viewActes(true);">{{tr}}Compta.valid_money{{/tr}}</button>
          {{else}}
            <button class="print me-secondary" type="submit" onclick="changeLink(this.form, 'print_actes');">
              {{tr}}Compta.valid_money{{/tr}}
            </button>
            <button class="download notext me-tertiary" type="submit" onclick="changeLink(this.form, 'print_actes', null, true);">
              {{tr}}Compta.valid_money{{/tr}}
            </button>
          {{/if}}
        </td>
        <td>
          <button class="download notext me-tertiary" type="button" onclick="changeLink(this.form, 'print_compta', 'etab', true);" style="float:right;">
            {{tr}}Compta.print{{/tr}}
          </button>
          <button class="print" type="button" onclick="changeLink(this.form, 'print_compta', 'etab');" style="float:right;">
            {{tr}}Compta.print{{/tr}}
          </button>
        </td>
        <td>
          <button class="print" type="button" onclick="changeLink(this.form, 'print_bordereau', 'etab');" style="float:left;">
            {{tr}}Compta.print_cheque{{/tr}}
          </button>
        </td>
      </tr>
      ...
      {{if $use_cotation_tarmed}}
        ...
        <tr>
          <td class="button" colspan="2">
            <button type="button" onclick="Facture.importV11('CFactureEtablissement');" class="hslip">
              {{tr}}Gestion.import_v11{{/tr}}
            </button>
            <button type="button" onclick="Facture.importCamt054('CFactureEtablissement');" class="hslip">
              {{tr}}Gestion.importCamt054{{/tr}}
            </button>
          </td>
          <td colspan="2" class="text">
        ...
        <tr>
          <td class="button" colspan="2">
            <button type="button" class="print" onclick="Facture.printGestion('bvr', 'CFactureEtablissement', document.printFrm, 1);">
              {{tr}}BVR.print{{/tr}}
            </button>
            <button type="button" class="print"
                    onclick="Facture.printGestion('justificatif', 'CFactureEtablissement', document.printFrm, 1);">
              {{tr}}Justif.print{{/tr}}
            </button>
          </td>
          <td rowspan="2" colspan="2" class="text button">
            <div class="small-info" id="response_send_bill">
              {{tr}}BVR.print.desc{{/tr}}
            </div>
            <button type="button" class="pdf" onclick="Facture.printGestion('bvr', 'CFactureEtablissement', document.printFrm, 0);">
              {{tr}}BVR.view{{/tr}}
            </button>
            <button type="button" class="pdf"
                    onclick="Facture.printGestion('justificatif', 'CFactureEtablissement', document.printFrm, 0);">
              {{tr}}Justif.view{{/tr}}
            </button>
          </td>
        </tr>
        <tr>
          <td class="button" colspan="2">
            <button type="button" class="send" onclick="checkBills('CFactureEtablissement');">{{tr}}Generate_xml.Tarmed{{/tr}}</button>
          </td>
        </tr>
      {{/if}}
    {{/if}}
    ...
    <tr>
      <td colspan="2" class="button">
        <button type="button" class="search me-primary" onclick="Facture.viewTotaux();">{{tr}}mod-dPfacturation-tab-ajax_total_cotation{{/tr}}</button>
      </td>
      <td colspan="2"></td>
    </tr>
  </table>
