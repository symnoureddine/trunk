...
{{if count($listPrat)}}
          ...
          <div>
            <div id="chir_view_container">
              <input type="text" name="chir_view" class="autocomplete"
                     ...
                     onmousedown="$V(this, '');" onblur="if (!$V(this)){$V(this, '&mdash; {{tr}}common-all|pl{{/tr}}');$V(this.form.chir, '');}"
            ...
            <div id="all_chir_view_container" style="display:none">
              <input type="text" name="all_chir_view" class="autocomplete" value="&mdash; {{tr}}common-all|pl{{/tr}}" style="text-align: left;"
                     onmousedown="$V(this, '');" onblur="if (!$V(this)){$V(this, '&mdash; {{tr}}common-all|pl{{/tr}}');$V(this.form.chir, '');}"
                     placeholder="&mdash; {{tr}}CMediusers-select-praticien{{/tr}}"/>
            </div>
          </div>
  ...
  {{if "dPfacturation CRelance use_relances"|gconf || "dPfacturation CJournalBill use_journaux"|gconf || $conf.ref_pays == 2}}
    <ul id="tabs-configure" class="control_tabs">
      ...
      {{/if}}
      <li><a href="#autres_exports">{{tr}}CFacture.others_exports{{/tr}}</a></li>
    </ul>
    ...
    {{/if}}
    <div id="autres_exports" style="display: none;">
      {{mb_include module=facturation template=vw_others_exports}}
    </div>
