...
{{if @$modules.tarmed->_can->read && 'tarmed CCodeTarmed use_cotation_tarmed'|gconf}}
  ...
  <div id="check_bill_relance" style="display:none;" data-count="" data-source_envoi=""></div>
{{/if}}
  ...
  <table class="form me-no-align me-no-box-shadow">
      ...
      <tr>
        ...
        {{if $use_cotation_tarmed}}
          <td rowspan="2" class="button">
            <button type="button" class="send" onclick="Relance.checkBills('CFactureCabinet');">{{tr}}CRelance.generate_dossier{{/tr}}</button>
          </td>
        {{/if}}
      </tr>
      <tr>
    ...
    {{if "dPfacturation CFactureEtablissement view_bill"|gconf}}
      ...
      <tr>
        ...
        {{if $use_cotation_tarmed}}
          <td rowspan="2" class="button">
            <button type="button" class="send" onclick="Relance.checkBills('CFactureEtablissement');">{{tr}}CRelance.generate_dossier{{/tr}}</button>
          </td>
        {{/if}}
      </tr>
      <tr>
