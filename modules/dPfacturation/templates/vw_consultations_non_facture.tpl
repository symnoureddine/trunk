          ...
          <td>
            <table class="form">
              ...
              {{if @$modules.tarmed->_can->read && 'tarmed CCodeTarmed use_cotation_tarmed'|gconf}}
                <tr>
                  {{if $consult->_ref_actes_tarmed|@count}}
                    <td style="width: 15%;">{{tr}}CConsultation-codes_tarmed{{/tr}}</td>
                  {{/if}}
                  <td>
                ...
                <tr>
                  {{if $consult->_ref_actes_caisse|@count}}
                    <td style="width: 15%;">{{tr}}CConsultation-codes_prestation{{/tr}}</td>
                  {{/if}}
                  <td>
