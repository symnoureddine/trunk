...
$consultations = CStoredObject::massLoadBackRefs($listPlages, "consultations", null, array("annule" => "= '0'"));
...
// Création du template
  ...
  $file->writeLine(
    array(
      CAppUI::tr("CConsultation-patient_id"), CAppUI::tr("CConsultation-_prat_id"),
      CAppUI::tr("CPlageConsult.remplacement_of")." / ".CAppUI::tr("CPlageconsult-pour_compte_id"),
      CAppUI::tr("CPlageconsult-date"), CAppUI::tr("CConsultation-heure"), CAppUI::tr("CConsultation-tarif"),
      CAppUI::tr("CReglement-montant"), CAppUI::tr("CFactureCabinet-_montant_retrocession"),
