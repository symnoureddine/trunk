...
CCanDo::checkEdit();
$date_min         = CView::get("_date_min", array('date', 'default' => CMbDT::date()), true);
$date_max         = CView::get("_date_max", array('date', 'default' => CMbDT::date()), true);
...
if ($function_compta && $function->compta_partagee) {
  $users = $function->loadRefsUsers(
    array('Chirurgien', 'Anesthésiste', 'Médecin', 'Dentiste', 'Infirmière', 'Rééducateur', 'Sage Femme', 'Diététicien')
  );
