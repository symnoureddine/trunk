...
<div id="view_dossier_pmsi" class="me-padding-0">
  ...
  <ul id="tabs-pmsi" class="control_tabs">
    ...
    {{/if}}
    {{if "atih"|module_active && "atih CGroupage use_fg"|gconf && $sejour->type !== "ambu" && !in_array($sejour->type, 'Ox\Mediboard\PlanningOp\CSejour::getTypesSejoursUrgence'|static_call:$sejour->praticien_id)}}
