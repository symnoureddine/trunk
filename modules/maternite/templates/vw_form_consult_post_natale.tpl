...
<script>
  Main.add(function () {
    Control.Tabs.create('tab-consult_postnatale-{{$consult_post_natale->_guid}}', true, {
      ...
      unfolded: true{{/if}}});
    Control.Tabs.create('tab-naissances-{{$consult_post_natale->_guid}}', true, {foldable: true {{if $print}}, unfolded: true{{/if}}});
  });
</script>
<ul id="tab-consult_postnatale-{{$consult_post_natale->_guid}}" class="control_tabs">
  <li><a href="#interrogatoire-{{$consult_post_natale->_guid}}">{{tr}}CConsultationPostNatale-interrogatoire{{/tr}}</a></li>
  <li><a href="#examen_clinique-{{$consult_post_natale->_guid}}">{{tr}}CConsultationPostNatale-examen{{/tr}}</a></li>
  <li>
    <a href="#information_prescriptions-{{$consult_post_natale->_guid}}">{{tr}}CConsultationPostNatale-info_prescription{{/tr}}</a>
  </li>
</ul>
        ...
        <fieldset>
              ...
              {{foreach from=$grossesse->_ref_naissances item=naissance}}
                ...
                <li>
                  <a href="#tab-{{$consult_post_natale->_guid}}-{{$naissance->_guid}}">
                    ...
                    <br />
                    {{mb_value object=$enfant field=naissance}} ({{mb_value object=$enfant field=_age}})
                  </a>
                </li>
              {{/foreach}}
              <li style="float: right;">
                <button type="button" class="add not-printable me-float-none" style="float: left;" {{if !$grossesse->active}}disabled{{/if}}
          ...
          {{foreach from=$grossesse->_ref_naissances item=naissance}}
            ...
            <div id="tab-{{$consult_post_natale->_guid}}-{{$naissance->_guid}}">
              <form name="Consult-postnatale-enfant-{{$consult_post_natale->_guid}}-{{$naissance->_guid}}" method="post"
                ...
                <input type="hidden" name="consultation_post_natale_id" value="{{$consult_post_natale->_id}}" />
                <input type="hidden" name="_count_changes" value="0" />
                <table class="form me-no-align me-no-box-shadow me-small-form">
                  <tr>
                    <th class="halfPane">{{mb_label object=$_consult_postnat_enfant field=enfant_present}}</th>
                    <td class="narrow">{{mb_field object=$_consult_postnat_enfant field=enfant_present default=""}}</td>
                  ...
                  <tr>
                    ...
                    <td colspan="3">{{mb_field object=$_consult_postnat_enfant field=rehospitalisation default=""}}</td>
                  </tr>
                  <tr>
                    <th>{{mb_label object=$_consult_postnat_enfant field=motif_rehospitalisation}}</th>
                    <td colspan="3">{{mb_field object=$_consult_postnat_enfant field=motif_rehospitalisation}}</td>
                  </tr>
                  <tr>
                    <th>{{mb_label object=$_consult_postnat_enfant field=etat_enfant}}</th>
                    <td colspan="3">
                  ...
                  <tr>
                    ...
                    <td colspan="3">{{mb_field object=$_consult_postnat_enfant field=nb_semaines_allaitement}}</td>
                  </tr>
                  <tr>
                    <th>{{mb_label object=$_consult_postnat_enfant field=motif_arret_allaitement}}</th>
                    <td colspan="3">{{mb_field object=$_consult_postnat_enfant field=motif_arret_allaitement}}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3">{{mb_field object=$_consult_postnat_enfant field=indication_complement}}</td>
                  </tr>
                </table>
              </form>
            </div>
          ...
          <form name="Consult-postnatale-maman-{{$consult_post_natale->_guid}}" method="post"
            ...
            <table class="form me-no-align me-no-box-shadow me-small-form">
              <tr>
                ...
                <td colspan="3">{{mb_field object=$consult_post_natale field=patho_postacc default=""}}</td>
              </tr>
              <tr>
                <th>{{tr}}CConsultationPostNatale-if_yes{{/tr}}, {{mb_label object=$consult_post_natale field=hospi_postacc}}</th>
                <td colspan="3">{{mb_field object=$consult_post_natale field=hospi_postacc default=""}}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3">{{mb_field object=$consult_post_natale field=duree_hospi_postacc}} j</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3">{{mb_field object=$consult_post_natale field=troubles_fct default=""}}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3">{{mb_field object=$consult_post_natale field=retour_couches default=""}}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3">{{mb_field object=$consult_post_natale field=reprise_rapports default=""}}</td>
              </tr>
              <tr>
          ...
          <form name="Consult-postnatale-examen-{{$consult_post_natale->_guid}}" method="post"
            ...
            <table class="form me-no-align me-no-box-shadow me-small-form">
              ...
              <tr>
                ...
                <th class="narrow">{{mb_label object=$consult_post_natale field=exam_stat_pelv_testing}}</th>
...
<div id="information_prescriptions-{{$consult_post_natale->_guid}}" style="display: none;">
  <form name="Consult-postnatale-info-presc-{{$consult_post_natale->_guid}}" method="post" onsubmit="return onSubmitFormAjax(this);">
    {{mb_class object=$consult_post_natale}}
    {{mb_key   object=$consult_post_natale}}
    <input type="hidden" name="_count_changes" value="0" />
