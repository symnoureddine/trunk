        ...
        <form name="Reanimation-{{$naissance->_guid}}" method="post"
          ...
          <fieldset>
            <legend>
              ...
              {{mb_field object=$naissance field=reanimation default="" onchange="DossierMater.checkFieldMandatory(this.form, this);"}}
            </legend>
            <table class="form">
              <tr>
                <th class="thirdPane">Si oui,</th>
              ...
              <tr>
                <th>{{mb_label object=$naissance field=rea_par}}</th>
                <td colspan="3">
                  {{mb_field object=$naissance field=rea_par
                  style="width: 20em;" emptyLabel="CNaissance.rea_par."}}
                  {{mb_label object=$naissance field=rea_par_id style="display: none;"}}
                  {{mb_field object=$naissance field=rea_par_id style="width: 20em;"
                  options=$profssante}}
                </td>
              </tr>
              <tr>
