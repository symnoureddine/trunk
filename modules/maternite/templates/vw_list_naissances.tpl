        ...
        {{foreach from=$services_selected key=_nom_service item=naissances}}
            ...
            {{foreach from=$naissances item=_naissance}}
                ...
                <tr>
                    ...
                    <td>
                        <a href="#1" onclick="Sejour.showDossierSoinsModal('{{$sejour->_id}}', 'suivi_clinique');">
                    ...
                    <td>
                        {{if $oea_exam && ($oea_exam|@count > 0)}}
                            {{if $examen_nouveau_ne->oreille_droite === 'positif'
                            && $examen_nouveau_ne->oreille_gauche === 'positif'}}
                                <i class="fa fa-check" style="color: #078227"></i>
                            {{elseif $examen_nouveau_ne->oreille_droite === 'negatif'
                            && $examen_nouveau_ne->oreille_gauche === 'negatif'}}
                                <i class="fa fa-times" style="color: #820001"></i>
                            {{else}}
                                <i class="fa fa-exclamation-triangle" style="color: #ffc107"></i>
                            {{/if}}
                            <span
                              onmouseover="ObjectTooltip.createDOM(this, 'oea_{{$_naissance->_id}}');">
                                {{tr}}common-Yes{{/tr}}
                            </span>
                            <div id="oea_{{$_naissance->_id}}" style="display: none;">
                                <table class="tbl">
                                    <tr>
                                        <th colspan="6">
                                    ...
                                    {{foreach from=$_naissance->_ref_examen_nouveau_ne key=key item=_examen
                                    name="examen_nouveau_ne"}}
                                        {{assign var=administrateur_oea
                                        value='Ox\Mediboard\Mediusers\CMediusers::get'|static_call:$_examen->examinateur_id}}
                                        <tr>
                                            <td>
                                                {{$_examen->date|date_format:$conf.date}}
                                            </td>
                                            <td>
                                                <span onmouseover="ObjectTooltip.createEx(
                                                  this,
                                            ...
                                            <td>
                                                {{tr}}CExamenNouveauNe.oreille_droite.{{$_examen->oreille_droite}}{{/tr}}
                                            </td>
                                            <td>
                                                {{tr}}CExamenNouveauNe.oreille_gauche.{{$_examen->oreille_gauche}}{{/tr}}
                                            </td>
                                            <td class="me-text-align-center">
                                                {{if $_examen->oreille_droite === 'positif'
                                                && $_examen->oreille_gauche === 'positif'}}
                                                    <i class="fa fa-check" style="color: #078227"></i>
                                                {{elseif $_examen->oreille_droite === 'negatif'
                                                && $_examen->oreille_gauche === 'negatif'}}
                                                    <i class="fa fa-times" style="color: #820001"></i>
                                                {{else}}
                                                    <i class="fa fa-exclamation-triangle" style="color: #ffc107"></i>
                                                {{/if}}
                                            </td>
                                            <td>{{mb_value object=$examen_nouveau_ne field=rdv_orl}}</td>
                                        </tr>
                                    {{/foreach}}
                                </table>
                            </div>
