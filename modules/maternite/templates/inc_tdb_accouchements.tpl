...
<table class="tbl me-no-align" id="accouchements_tab">
  ...
  <tr>
    <th class="title me-text-align-center" colspan="10">
      ...
      <button type="button" class="change notext me-tertiary" onclick="Tdb.views.listAccouchements();" style="float: right;">
        {{tr}}Refresh{{/tr}}
      </button>
      <button type="button" class="edit me-tertiary" onclick="Tdb.checklistsOpenSalle('{{$date}}');" style="float: right;"
