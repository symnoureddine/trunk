...
{{if $dossier->_listChapitres|is_array}}
  <table class="main layout">
    <tr>
      <td class="halfPane">
        <fieldset>
          <legend class="dossier-perinatal-font-size-legend">{{tr}}CDossierPerinat-debut_grossesse{{/tr}}</legend>
          <ul>
            {{foreach from=$dossier->_listChapitres.debut_grossesse item=chapitre key=nom_chapitre}}
              <li {{if $chapitre.dev != 'ko'}}onclick="DossierMater.openPage({{$grossesse->_id}}, '{{$nom_chapitre}}', '{{$operation_id}}');"{{/if}}>
      ...
      <td>
        <fieldset>
          <legend class="dossier-perinatal-font-size-legend">{{tr}}CDossierPerinat-suivi_grossesse{{/tr}}</legend>
          <ul>
    ...
    <tr>
      {{if array_key_exists('accouchement', $dossier->_listChapitres)}}
        <td>
          <fieldset>
            <legend class="dossier-perinatal-font-size-legend">{{tr}}CDossierPerinat-accouchement{{/tr}}</legend>
      ...
      <td>
        <fieldset>
          <legend class="dossier-perinatal-font-size-legend">{{tr}}CDossierPerinat-suivi_accouchement{{/tr}}</legend>
          <ul>
