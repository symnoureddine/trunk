      ...
      <tr>
        ...
        <td colspan="5">
          <table class="form" style="width: 100%">
            ...
            <tr>
              <td style="width: 22%;">{{$_administration.datetime|date_format:$conf.datetime}}</td>
              <td style="width: 22%;">
                <span onmouseover="ObjectTooltip.createEx(this, '{{$administrateur_oea.guid}}');">{{$administrateur_oea.view}}</span>
              </td>
              <td style="width: 22%;">{{tr}}CExamenNouveauNe.oreille_droite.{{$_administration.oreille_droite}}{{/tr}}</td>
              <td style="width: 22%;">{{tr}}CExamenNouveauNe.oreille_gauche.{{$_administration.oreille_gauche}}{{/tr}}</td>
              <td style="width: 22%;">{{mb_value object=$examen_nouveau_ne field=rdv_orl}}</td>
            </tr>
            {{/foreach}}
            {{else}}
