          ...
          <tr>
            <td class="halfPane">
              <form name="constantesMater-{{$dossier->_guid}}" action="?" method="post"
                ...
                <table class="form me-no-align me-no-box-shadow me-small-form">
                  <tr>
                    <th class="title me-text-align-center" colspan="10">{{tr}}CDossierPerinat-Medical antecedent|pl{{/tr}}</th>
                  </tr>
                  <tr>
                    <th colspan="2">
              ...
              <form name="Antecedents-medicaux-{{$dossier->_guid}}" method="post"
                ...
                <table class="form me-no-box-shadow me-no-align me-small-form">
                  ...
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_hta  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_hta}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_diabete  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_diabete}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_epilepsie  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_epilepsie}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_asthme  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_asthme}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_pulm  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_pulm}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_thrombo_emb  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_thrombo_emb}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_cardio  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_cardio}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_auto_immune  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_auto_immune}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_hepato_dig  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_hepato_dig}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_thyroide  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_thyroide}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_uro_nephro  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_uro_nephro}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_infectieuse  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_infectieuse}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_hemato  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_hemato}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_cancer_non_gyn  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=patho_ant_cancer_non_gyn}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=patho_ant_psy  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'patho_ant_');"}}</th>
            ...
            <td>
              <form name="Antecedents-chir-gyneco-{{$dossier->_guid}}" method="post"
                ...
                <table class="form me-no-align me-no-box-shadow me-small-form">
                  <tr>
                    <th class="title me-text-align-center" colspan="2">Antecedents chirurgicaux</th>
                  </tr>
                  <tr>
                    <th class="halfPane">
                  ...
                  <tr>
                    <th class="title me-text-align-center" colspan="2">Antecedents gynécologiques</th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_herpes  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_herpes}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_lesion_col  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_lesion_col}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_conisation  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_conisation}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_cicatrice_uterus  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_cicatrice_uterus}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_fibrome  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_fibrome}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_stat_pelv  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_stat_pelv}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_cancer_sein  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_cancer_sein}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_cancer_app_genital  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_cancer_app_genital}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_malf_genitale  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_malf_genitale}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_condylomes  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_condylomes}}</td>
                  </tr>
                  <tr>
                    <th class="compact">{{mb_field object=$dossier field=gyneco_ant_distilbene  typeEnum=checkbox onchange="DossierMater.manageAntecedents(this, 'gyneco_ant_');"}}</th>
                    <td class="compact">{{mb_label object=$dossier field=gyneco_ant_distilbene}}</td>
                  </tr>
                  <tr>
...
<div id="antecedents_paternels" class="me-padding-2" style="display: none;">
        ...
        <td>
          ...
          <form name="Antecedents-pere-{{$dossier->_guid}}" method="post"
            ...
            <table class="form me-no-align me-no-box-shadow me-small-form">
              ...
              <tr>
                <th class="compact">{{mb_field object=$dossier field=pere_ant_herpes typeEnum=checkbox}}</th>
              ...
              <tr>
                ...
                <td class="compact">{{mb_field object=$dossier field=pere_ant_autre form=Antecedents-pere-`$dossier->_guid`}}</td>
              </tr>
            </table>
          </form>
        </td>
  ...
  {{else}}
    <div class=big-info>Le père n'a pas été spécifié</div>
  {{/if}}
</div>
      ...
      <tr>
        <td class="halfPane">
          ...
          <table class="form me-no-align me-no-box-shadow">
            <tr>
              <th class="narrow"></th>
              <th class="narrow category me-text-align-left">Famille de la mère de l'enfant</th>
              <th class="narrow category me-text-align-left">Famille du père de l'enfant</th>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_gemellite typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_malformations typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_maladie_genique typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_maladie_chrom typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_diabete typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_hta typeEnum=checkbox}}</td>
            </tr>
            <tr>
              ...
              <td>{{mb_field object=$dossier field=ant_fam_pere_phlebite typeEnum=checkbox}}</td>
            </tr>
            <tr>
  ...
  <table class="main layout">
    ...
    <tr>
      <td>
        <script>
          Main.add(function () {
            Control.Tabs.create('tab-grossesse', true, {foldable: true {{if $print}}, unfolded: true{{/if}}});
          });
        </script>

        <ul id="tab-grossesse" class="control_tabs small">
          <li><a href="#grossesses_anterieures">Grossesses antérieures</a></li>
          <li><a href="#grossesses_synthese">Synthèse des grossesse antérieures</a></li>
        </ul>
          ...
          <table class="tbl me-no-align">
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant name=backgrossesses}}
                <th colspan="3" style="width: 21em;">
                  ...
                  <button type="button" class="edit notext not-printable me-tertiary" style="float: left;"
            ...
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=issue_grossesse}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=grossesse_apres_amp}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=grossesse_apres_amp}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=complic_grossesse}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=transfert_in_utero}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=transfert_in_utero}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=mode_debut_travail}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=mode_debut_travail}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=mode_accouchement}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=vecu_grossesse}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=grossesse_multiple}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=grossesse_multiple}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              ...
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text" colspan="3">{{mb_value object=$grossesse_ant field=nombre_enfants}}</td>
              {{/foreach}}
              <td></td>
            </tr>
            <tr>
              <th>Si multiple pour chaque enfant</th>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=poids_naissance_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=etat_nouveau_ne_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=allaitement_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
                <td class="text">
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=malformation_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=maladie_hered_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=pathologie_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <tr>
              <td style="text-align: right;">{{mb_label class=CGrossesseAnt field=transf_mut_enfant1}}</td>
              {{foreach from=$grossesses_ant item=grossesse_ant}}
            ...
            <table class="main">
              <tr>
                <th colspan="4" class="title">
                  Synthèse des grossesse antérieures
                </th>
              </tr>
              <tr>
                <td class="halfPane">
                  <table class="form me-no-align me-no-box-shadow me-small-form">
                    <tr>
                      <th colspan="3" class="category">Nombre de grossesses</th>
                    </tr>
                    <tr>
                      <th class="category me-cell-medium-emphasis" rowspan="6">Dont l'issue est</th>
                    ...
                    <tr>
                      <th colspan="2" class="halfPane">{{mb_label object=$dossier field=ant_obst_nb_gr_amp}}</th>
                      <td>{{mb_field object=$dossier field=ant_obst_nb_gr_amp}}</td>
                    </tr>
                    <tr>
                      <th colspan="2" class="halfPane">{{mb_label object=$dossier field=ant_obst_nb_gr_mult}}</th>
                      <td>{{mb_field object=$dossier field=ant_obst_nb_gr_mult}}</td>
                    </tr>
                    <tr>
                      <th class="category me-cell-medium-emphasis" rowspan="3">Compliquées de</th>
                    ...
                    <tr>
                      <th class="category me-cell-medium-emphasis" rowspan="2">Terminées par</th>
                ...
                <td class="halfPane">
                  <table class="form me-no-align me-no-box-shadow me-small-form">
                    <tr>
                      <th colspan="2" class="category">Nombre d'enfants</th>
                    </tr>
                    <tr>
                      <th class="halfPane">{{mb_label object=$dossier field=ant_obst_nb_enf_moins_25000}}</th>
