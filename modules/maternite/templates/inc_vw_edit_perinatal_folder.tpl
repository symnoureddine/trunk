...
<form name="edit_last_screenings" method="post" onsubmit="return onSubmitFormAjax(this);">
...
<form name="edit_folder_light" method="post" onsubmit="return onSubmitFormAjax(this, Control.Modal.close);">
  {{mb_class object=$dossier}}
  {{mb_key   object=$dossier}}
  <!--current_pregnancy-->
