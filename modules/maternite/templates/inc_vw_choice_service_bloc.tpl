...
<form name="choice_lit_or_room" method="post" onsubmit="">
  ...
  <input type="hidden" name="_current_bloc_id" value="{{$bloc->_id}}"/>
  <input type="hidden" name="_service_id"/>
  ...
  <table class="main form">
    ...
    <tr>
      <td class="button" colspan="2">
        <button type="button" class="tick" onclick="Placement.submitLitOrSalle(this.form, '{{$sejour->_guid}}', '{{$location}}',);">
          {{tr}}Move{{/tr}}
        </button>
      </td>
    </tr>
