...
<table class="main" style="{{$css}}">
  ...
  <tr>
    ...
    {{mb_field object=$last_depistage field=_date_depistage register=true form="edit_perinatal_folder" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=rubeole class="card_input"}}
    {{mb_field object=$last_depistage field=rubeole emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}

    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=toxoplasmose class="card_input"}}
    {{mb_field object=$last_depistage field=toxoplasmose emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=syphilis class="card_input"}}
    {{mb_field object=$last_depistage field=syphilis emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}

    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=vih class="card_input"}}
    {{mb_field object=$last_depistage field=vih emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=hepatite_b class="card_input"}}
    {{mb_field object=$last_depistage field=hepatite_b emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}

    {{me_form_field animated=false nb_cells=2 mb_object=$last_depistage mb_field=hepatite_c class="card_input"}}
    {{mb_field object=$last_depistage field=hepatite_c emptyLabel="common-Not specified" onchange="DossierMater.bindingDatas(this, getForm('edit_last_screenings'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    <td colspan="8">
    ...
    <td class="halfPane" colspan="4">
      <table class="form fieldset_prelevement">
        ...
        <tr>
          ...
          {{mb_field object=$dossier field=resultat_prelevement_vaginal onchange="DossierMater.ShowElements(this, 'prelevement_vaginal_autre'); DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
          {{/me_form_field}}
        </tr>
    ...
    <td class="halfPane" colspan="4">
      <table class="form">
        ...
        <tr>
          ...
          {{mb_field object=$dossier field=resultat_prelevement_urinaire onchange="DossierMater.ShowElements(this, 'prelevement_urinaire_autre'); DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
          {{/me_form_field}}
        </tr>
