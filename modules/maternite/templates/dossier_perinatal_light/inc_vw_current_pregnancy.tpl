...
<table class="main" style="{{$css}}">
  ...
  <tr id="grossesse_multiple" style="{{if !$grossesse->multiple}}display: none;{{/if}}">
    ...
    {{mb_field object=$grossesse field=nb_foetus onchange="DossierMater.bindingDatas(this, getForm('edit_grossesse_light'));"}}
    {{/me_form_field}}

    {{me_form_field animated=false nb_cells=2 mb_object=$grossesse mb_field=type_embryons_debut_grossesse class="card_input"}}
    {{mb_field object=$grossesse field=type_embryons_debut_grossesse onchange="DossierMater.bindingDatas(this, getForm('edit_grossesse_light'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
  ...
  <tr>
    ...
    {{mb_field object=$last_poids.0 field=poids readonly=true}} kg
    {{/me_form_field}}
  ...
  <tr>
    {{me_form_field animated=false nb_cells=6 mb_object=$dossier mb_field=rques_traitement_grossesse class="card_input"}}
