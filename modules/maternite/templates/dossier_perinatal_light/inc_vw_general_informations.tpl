...
<table class="main" style="{{$css}}">
  ...
  <tr>
    ...
    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=rques_accompagnement style_css="$style_css" class="card_input situation_accompagnement"}}
  ...
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=pere_ant_autre class="card_input"}}
