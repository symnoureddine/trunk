...
<table class="main" style="{{$css}}">
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=projet_analgesie_peridurale onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}

    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=projet_allaitement_maternel class="card_input"}}
    {{mb_field object=$dossier field=projet_allaitement_maternel onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
<!--  <tr>
    <td>
      Champ texte antécédent allaitement
    </td>
  </tr>-->
  <tr>
    <th class="title_section">
