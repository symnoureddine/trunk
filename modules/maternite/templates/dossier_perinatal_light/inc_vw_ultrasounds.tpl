...
<table class="main" style="{{$css}}">
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=resultat_echo_1er_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  ...
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=ag_echo_1er_trim class="card_input"}}
    {{mb_field object=$dossier field=ag_echo_1er_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    <th class="subtitle_chapter subtitle_color_black">
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=resultat_echo_2e_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  ...
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=ag_echo_2e_trim class="card_input"}}
    {{mb_field object=$dossier field=ag_echo_2e_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    <th class="subtitle_chapter subtitle_color_black">
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=resultat_echo_3e_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  ...
  <tr>
    {{me_form_field animated=false nb_cells=2 mb_object=$dossier mb_field=ag_echo_3e_trim class="card_input"}}
    {{mb_field object=$dossier field=ag_echo_3e_trim onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
    <th class="subtitle_chapter subtitle_color_black">
  ...
  <tr>
    ...
    {{me_form_field animated=false nb_cells=2 mb_object=$echographique mb_field=pos_placentaire class="card_input"}}
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=sa_echo_fin_grossesse onchange="DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
  <tr>
