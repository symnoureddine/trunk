...
<table class="main" style="{{$css}}">
  ...
  <tr>
    ...
    {{mb_field object=$dossier field=pelvimetrie onchange="DossierMater.ShowElements(this, 'pelvimetrie'); DossierMater.bindingDatas(this, getForm('edit_folder_light'));"}}
    {{/me_form_field}}
  </tr>
