      ...
      <fieldset>
        ...
        <table class="tbl me-no-align me-no-box-shadow">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=coloration_globale}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=auscultation}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=crane}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=foie}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=jet_mictionnel}}</td>
            {{/foreach}}
            <td></td>
          </tr>
        </table>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=clavicules}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=cri}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=test_audition}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=oreille_droite}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=oreille_gauche}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=rdv_orl}}</td>
            {{/foreach}}
            <td></td>
          </tr>
        </table>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-align me-no-box-shadow">
          ...
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=guthrie_datetime}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=guthrie_user_id tooltip=true}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td class="text" style="width: 20em;">{{mb_value object=$examen field=guthrie_envoye}}</td>
            {{/foreach}}
            <td></td>
          </tr>
        </table>
      ...
      <fieldset>
        ...
        <table class="tbl me-no-box-shadow me-no-align">
          <tr>
            ...
            {{foreach from=$grossesse->_back.examens_nouveau_ne item=examen}}
              <td style="width: 20em;">{{if $examen->est_age_gest}}{{mb_value object=$examen field=est_age_gest}} SA{{/if}}</td>
            {{/foreach}}
            <td></td>
          </tr>
          <tr>
