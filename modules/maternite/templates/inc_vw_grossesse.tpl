...
<ul class="control_tabs small" id="tab-grossesse">
  ...
  {{if "monitoringMaternite"|module_active && "monitoringMaternite general active_graph_supervision"|gconf}}
    <li><a href="#surveillance_parto">{{tr}}CSupervisionGraphPack.use_contexts.parto{{/tr}}</a></li>
...
<div id="surveillance_parto" class="me-padding-1" style="display: none;"></div>
