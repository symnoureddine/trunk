...
$last_constantes  = CConstantesMedicales::getLatestFor($patient, null, ["poids", "taille"], $last_sejour, false);
        ...
        foreach ($_fields as $_field) {
            if (in_array($key_chapter, ["immuno", "serologie"])) {
                if (!isset($immuno_serology[$key_chapter][$_field])) {
                    $immuno_serology[$key_chapter][$_field] = html_entity_decode('&mdash;');
                }
