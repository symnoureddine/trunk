...
Placement = window.Placement || {
  ...
  pecPatiente: function(sejour_id) {
    new Url('maternite', 'ajax_pec_patiente')
      .addParam('sejour_id', sejour_id)
      .requestModal('90%', '90%');
  },
  ...
  callbackPecPatiente: function(consult_id) {
    ...
    Consultation.editModal(consult_id, null, null, Placement.refreshCurrPlacement);
  },
   ...
   */
  submitLitOrSalle: function(form, sejour_guid, location) {
    ...
    if (lit_id && service_id) {
      other_form = getForm(sejour_guid + "_move_service");
