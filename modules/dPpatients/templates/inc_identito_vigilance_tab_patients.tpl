...
<table class="main tbl">
  ...
  <tr>
    ...
    <th class="narrow">{{mb_title class=CUserLog field=date}}</th>
    <th class="narrow">{{mb_title class=CUserLog field=user_id}}</th>
  ...
  {{foreach from=$duplicates.duplicates item=_doublon}}
    <tr>
      ...
      <td style="text-align: center;">
        {{foreach from=$_doublon.patients item=_patient}}
          {{mb_value object=$_patient->_ref_creation_log field=date}}
          <br />
        {{/foreach}}
      </td>
      ...
      <td>
        {{foreach from=$_doublon.patients item=_patient}}
          {{mb_value object=$_patient->_ref_creation_log field=user_id tooltip=true}}
          <br />
        {{/foreach}}
      </td>
