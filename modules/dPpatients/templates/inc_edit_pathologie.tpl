...
<form name="editPathologie_{{$pathologie_guid}}" method="post" onsubmit="return onSubmitFormAjax(this, Control.Modal.close);">
  ...
  <table class="form">
    ...
    {{if $conf.ref_pays != "2" && $pathologie->type !== "probleme"}}
      <tr>
        <th>
