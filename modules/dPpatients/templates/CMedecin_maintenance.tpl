...
<ul class="control_tabs small" id="CMedecin-tab">
  <li><a href="#CMedecin-import-v2">{{tr}}CMedecinImport{{/tr}}</a></li>
  <li><a href="#CMedecin-install_trigger">Trigger medecin-patient</a></li>
  <li><a href="#CMedecin-tools">Outils</a></li>
</ul>

<div id="CMedecin-import-v2" style="display: none;">
  <div style="width: 49%; display: inline-block; vertical-align: top">
    {{mb_include module=openData template=inc_vw_import_medecins}}
  </div>
  <div style="width:49%; display: inline-block; vertical-align: top">
    {{mb_include module=openData template=inc_vw_conflict_options}}
  </div>
</div>
...
<div id="CMedecin-tools" style="display: none;">
  ...
  <div class="small-info">
    Cet outil permet d'effectuer une épuration des doublons de correspondants médicaux dûs à des importations en supprimant les
    doublons.
  </div>
    ...
    <table class="tbl">
      ...
      <tr>
        <td style="width: 20%">
          <table class="layout">
            <tr>
              <td><label> Traiter les doublons qui sont plus de <input type="number" name="count_min" value="50" size="5" /> </label>
              </td>
            </tr>
            <tr>
              <td><label> Dry run (n'effectue pas de suppression) <input type="checkbox" name="dry_run" value="1" checked /> </label>
              </td>
            </tr>
            <tr>
              <td>
