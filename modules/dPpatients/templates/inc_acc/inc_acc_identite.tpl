      ...
      <table class="form" id="patient_identite">
        ...
        <tr>
          ...
          <td>
            ...
            <button type="button" class="down notext" onclick="Patient.togglePrenomsList(this)"
        ...
        <tr>
          ...
          <td colspan="2" class="td-directives-anticipees">
            ...
            {{if $patient->directives_anticipees == 1}}
              <button type="button" class="search notext" title="{{tr}}CDirectiveAnticipee-action-See advance directive|pl{{/tr}}"
