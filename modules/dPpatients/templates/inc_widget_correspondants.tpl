...
<script>
  ...
  showConflicts = function () {
    ...
    url.addParam('medecin_id', '{{$medecin_ids}}');
  ...
  {{if $patient && $patient->_id}}
    <tr>
      ...
      <td>
        ...
        {{if $patient->_id}}
          {{assign var=pharmacie_view value=$patient->_ref_pharmacie->_view}}
        {{/if}}
      ...
      <tr>
        ...
        <td>
          ...
          <form name="correspondant-edit-{{$curr_corresp->_id}}" method="post" onsubmit="return false;">
            ...
            <input type="text" name="_view" size="50" value="{{$curr_corresp->_ref_medecin->_view}}"
    ...
    <tr>
      ...
      <td>
        <div class="small-warning">
          {{tr}}CImportConflict-medecin conflict exists|pl{{/tr}}.
          <br />

          <button class="button search" type="button" onclick="showConflicts()">
