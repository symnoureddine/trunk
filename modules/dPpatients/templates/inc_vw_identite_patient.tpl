...
<table class="form me-align-auto me-margin-bottom-8">
  ...
  <tr>
    ...
    <th class="me-color-black-medium-emphasis">{{mb_label object=$patient field="nom"}}</th>
    <td>{{mb_value object=$patient field="nom"}}</td>
    <th class="me-color-black-medium-emphasis" rowspan="2">{{mb_label object=$patient field="adresse"}}</th>
  ...
  <tr>
    <th class="me-color-black-medium-emphasis">{{mb_label object=$patient field="sexe"}}</th>
  ...
  <tr>
    <th class="me-color-black-medium-emphasis">{{mb_label object=$patient field="_age"}}</th>
    <td>
  ...
  <tr>
    <th class="me-color-black-medium-emphasis" colspan="2">{{mb_label object=$patient field="nom_jeune_fille"}}</th>
  ...
  <tr>
    <th class="me-color-black-medium-emphasis" colspan="2"></th>
    <td></td>
  ...
  {{if $patient->rques || $patient->matricule || $patient->avs}}
    <tr>
      <th class="me-color-black-medium-emphasis" colspan="2">{{mb_label object=$patient field="rques"}}</th>
      <td class="text">
        {{mb_value object=$patient field="rques"}}
      </td>
      {{if $conf.ref_pays == 1}}
        <th class="me-color-black-medium-emphasis">{{mb_label object=$patient field="matricule"}}</th>
        <td>{{mb_value object=$patient field="matricule"}}</td>
      {{else}}
        <th class="me-color-black-medium-emphasis">{{mb_label object=$patient field="avs"}}</th>
