...
<script>
  Main.add(function () {
    ...
    InseeFields.initCPVille("editFrm", "assure_cp", "assure_ville", null, "assure_pays_insee");
    InseeFields.initCPVille("editFrm", "assure_cp_naissance", "assure_lieu_naissance", null, "_assure_pays_naissance_insee");
  ...
  <tr>
    <td colspan="6" class="me-padding-0">
      ...
      <form name="editFrm" {{if !$modal}}action="?m={{$m}}"{{/if}} method="post" onsubmit="return Patient.confirmCreation(this)"
        ...
        {{mb_field object=$patient field="_source_nom" hidden=1 canNull=true}}
        {{mb_field object=$patient field="_source_nom_jeune_fille" hidden=1}}
        ...
        {{mb_field object=$patient field="_type_justificatif" hidden=1}}
