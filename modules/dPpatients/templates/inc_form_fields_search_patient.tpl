...
<tr>
  ...
  {{assign var=field_card value="_matricule"}}

  {{if $pays == 2}}
    {{assign var=field_card value="_avs"}}
  {{/if}}

  {{me_form_field style_css="display: none;" nb_cells=2 class="field_advanced" mb_class="CPatient" mb_field=$field_card null_chars="_| "}}
      {{mb_field class=CPatient field=$field_card}}
  {{/me_form_field}}
</tr>