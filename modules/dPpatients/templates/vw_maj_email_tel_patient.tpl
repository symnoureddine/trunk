...
{{if $in_dhe && $med_trait_mandatory}}
  ...
  <script>
    ...
    Main.add(function () {
      var form = getForm('editEmailTelPatient_{{$patient->_id}}');
...
<form name="editEmailTelPatient_{{$patient->_id}}" method="post" onsubmit="onSubmitFormAjax(this, updateStatusCloseButton);">
