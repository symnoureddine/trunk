...
class CConstantSpec extends CStoredObject
{
    ...
    {
        $cache = new Cache(__METHOD__, "releve_constant_list", Cache::INNER_DISTR);
        if ($data = $cache->get()) {
            return $data;
        }
     ...
     * @return void
     */
    private function deserializeUnit(): void
    {
    ...
    {
        return CMbArray::get(self::getListSpecByCode(self::$ALL_SPECS), $name, null);
    }
    ...
    {
        return CMbArray::get(self::getListSpecById(self::$ALL_SPECS), $id, null);
    }
    ...
    public function getProps()
    {
        ...
        $props["_scope"]        = "enum list|" . implode("|", $scopes);
