 ...
 * Antecedent
 */
class CAntecedent extends CMbObject implements ImportableInterface{
    /** @var string */
    public const RESOURCE_NAME = 'antecedent';
  ...
  function loadRefsCodesSnomed() {
    ...
    public function getResourceMedicalRecord(): ?CItem
    {
        ...
        $item = new CItem($dossier_medical);
        $item->setName(CDossierMedical::RESOURCE_NAME);
