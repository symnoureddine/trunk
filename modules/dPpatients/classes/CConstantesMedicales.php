...
class CConstantesMedicales extends CMbObject {
  ...
  static $list_constantes = array(
    ...
    "glycemie"             => array(
      ...
      "unit"        => "g/l",
      "min"         => 0, "max" => 4,
      "conversion"  => array("mmol/l" => 5.56, 'mg/dl' => 100, 'µmol/l' => 5560), // 1 g/l => 5.56 mmol/l, 1 g/l => 100 mg/dl, 1 g/l => 5560 µmol/l
    ...
    "creatininemie"           => array(
      ...
      "unit"        => "mg/L",
      "min"         => 0, "max" => 30,
      "conversion"  => array("µmol/l" => 8.8402),
  ...
  function updateFormFields() {
    ...
    //Récupération du premier poids si bébé
