...
class CCorrespondantPatient extends CPerson {
  /** @var string  */
  public const RESOURCE_NAME = 'correspondantPatient';
  ...
  function getProps() {
    ...
    $props["relation"]        = "enum list|assurance|autre|confiance|employeur|inconnu|prevenir|representant_legal" .
      "|representant_th|transport|parent_proche|ne_pas_prevenir default|prevenir fieldset|default";
