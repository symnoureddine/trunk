  ...
  public function register() {
    ...
    foreach (CConstantesMedicales::$list_constantes as $_constante => $_params) {
      if (!isset($_params["cumul_for"])) {
        if (!in_array($_constante, array('poids', 'taille', 'pouls', 'temperature', 'ta', 'EVA', 'frequence_respiratoire'))) {
          $mode     = 'fixed';
          $min      = $_params['min'];
          $max      = $_params['max'];
          $norm_min = 0;
    ...
    CConfiguration::register(
      array(
        'CGroups' => array(
          'dPpatients' => array(
            ...
            'CConstantesMedicales' => array(
              ...
              'unite_glycemie'    => 'enum list|g/l|mmol/l|mg/dl|µmol/l default|' . CAppUI::conf('dPpatients CConstantesMedicales unite_glycemie'),
        ...
        'CBlocOperatoire CGroups.group_id' => array(
          'dPpatients' => array(
            'CConstantesMedicales' => array(
              'show_cat_tabs'  => 'bool default|0',
              'stacked_graphs' => 'bool default|0'
        ...
        "constantes / CBlocOperatoire CGroups.group_id" => array(
          "dPpatients" => array(
            "CConstantesMedicales" => array(
