...
list($can_edit, $disable_edit_motif, $modif_timeout) = $constantes->getEditReleve($perms, $constantes, $modif_timeout, $context_guid, $can_edit);

if ($constantes->loadRefReleveRedon()->_id) {
  $can_edit = 0;
}
