...
Main.add(function() {
  Control.Tabs.create('tabs-translations', true, {
    afterChange: function (container) {
      var file = (container.id === 'tab-vw-translations') ? 'mnt_traduction_classes' : 'vw_integrate_translations';
...
<ul id="tabs-translations" class="control_tabs">
  <li><a href="#tab-vw-translations">{{tr}}mod-dPdeveloppement-tab-mnt_traduction_classes{{/tr}}</a></li>
  {{if $conf.debug}}
