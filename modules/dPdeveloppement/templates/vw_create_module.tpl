        ...
        <button type="button" class="submit"
                onclick="
                  GenModuleIcono.genImage(
                    $('icono_module'),
                    'canvas_module',
                    $V(this.form.trigramme),
                    this.form.mod_category[this.form.mod_category.selectedIndex].get('color'),
                    function(canvas) {
                      $V($('mod_image'), canvas.toDataURL());
                      this.form.onsubmit();
                    }.bind(this)
                  )">
          Créer le module
        </button>
        <div style="display: none;" id="icono_module">
