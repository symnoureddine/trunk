...
class RoutesController extends CLegacyController
{
    ...
    public function ajax_details_route(): void
    {
        ...
        $routes = CRouter::getInstance()->getRouteCollection();
    ...
    public function ajax_match_routes(): void
    {
        $this->checkPermAdmin();
        $url    = CView::get('url', 'str');
        $url    = $url ? str_replace('\\\\', '\\', $url) : null;
        $method = CView::get('method', 'str');
        ...
        $this->renderSmarty('vw_match_route', $tpl_vars);
    }
    ...
    public function vw_create_route(): void
    {
        ...
        $tpl_vars = [
            'allowed_methods'     => CRouteManager::ALLOWED_METHODS,
            'allowed_accept'      => CRequestFormats::FORMATS,
            'allowed_accept_body' => CRequestFormats::FORMATS_BODY,
            'allowed_security'    => array_keys(CAuthentication::SERVICES),
            'allowed_permissions' => CRouteManager::ALLOWED_PERMISSIONS,
    ...
    public function ajax_create_route()
    {
        ...
        $arguments = [
            ...
            'security'       => CView::get('security', 'str'),
            'permission'     => CView::get(
                'permission',
                'enum list|' . implode('|', CRouteManager::ALLOWED_PERMISSIONS) . ' default|none'
            ),
        ...
        } catch (CRouteException | CControllerException $e) {
