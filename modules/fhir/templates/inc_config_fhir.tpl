...
<form name="editConfigFHIR" action="?m=fhir&a=configure" method="post" onsubmit="return onSubmitFormAjax(this)">
  ...
  <table class="form">
    ...
    {{assign var=fhir_versions value='Ox\Interop\Fhir\CFHIR'|static:"versions"}}
    {{mb_include module=system template=inc_config_enum var=version values=$fhir_versions}}
