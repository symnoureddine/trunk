...
class CDevisCodage extends CCodable {
  ...
  public function store() {
    ...
    if (CAppUI::gconf('dPcabinet CDevisCodage codage_interv_anesth') && $this->codable_class == 'CConsultation'
   ...
   * @return string|bool
   */
  protected function setFromObject($object, $activity = null) {
    ...
    if (array_key_exists($this->praticien_id, $object->_ref_codages_ccam)) {
      ...
      foreach ($object->_ref_codages_ccam[$this->praticien_id] as $_model_codage) {
        if (!$activity || ($_model_codage->activite_anesth == '1' && $activity == '4')
   ...
   * @return string
   */
  public function printTableActesNGAP() {
    $this->loadRefsActesNGAP();
   ...
   * @return string
   */
  public function printTableActesCCAM() {
    $this->loadRefsActesCCAM();
   ...
   * @return string
   */
  public function printTableFraisDivers() {
    $this->loadRefsFraisDivers();
