...
class CExtensionPMSI extends CCCAM {
   ...
   */
  public static function load($code, $extension, $date = null) {
    self::getSpec();
    $ds = self::$spec->ds;
    ...
    $query = "SELECT * FROM p_acte_extension_pmsi
      WHERE p_acte_extension_pmsi.CODEACTE = %1 AND p_acte_extension_pmsi.EXTENSIONPMSI = %2 AND p_acte_extension_pmsi.DATEDEBUT <= %3
   ...
   */
  public static function loadList($code, $date = null) {
    self::getSpec();
    $ds = self::$spec->ds;
   ...
   * @return string
   */
  public static function convertDateToMb($date) {
   ...
   * @return string
   */
  public static function convertDateToCCAM($date) {
