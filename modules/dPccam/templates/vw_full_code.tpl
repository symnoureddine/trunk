    ...
    <td class="pane">
      <table>
                ...
                <td class="button">
                  ...
                  <form name="addFavoris" method="post" onsubmit="return onSubmitFormAjax(this)">
                    ...
                    <select name="object_class">
                      <option value="COperation"    {{if $object_class == "COperation"}}   selected{{/if}}>{{tr}}COperation{{/tr}}   </option>
                      <option value="CConsultation" {{if $object_class == "CConsultation"}}selected{{/if}}>{{tr}}CConsultation{{/tr}}</option>
                      <option value="CSejour"       {{if $object_class == "CSejour"}}      selected{{/if}}>{{tr}}CSejour{{/tr}}      </option>
                    </select>
                    <button id="btn_add_fav_user" class="submit" type="button" onclick="$V(this.form.elements['favoris_function'], ''); this.form.onsubmit();"{{if !$codeacte || $codeacte == '-'}} disabled{{/if}}>
                      Ajouter à mes favoris
                    </button>
                    <button id="btn_add_fav_function" class="submit" type="button" onclick="$V(this.form.elements['favoris_user'], ''); this.form.onsubmit();"{{if !$codeacte || $codeacte == '-'}} disabled{{/if}}>
                ...
                <tr>
                  ...
                  <td>
                    <select name="situation_patient">
                      <option value="none"{{if $situation_patient == 'none'}} selected{{/if}}>Hors CMU/ACS</option>
                      <option value="cmu"{{if $situation_patient == 'cmu'}} selected{{/if}}>CMU-C</option>
        ...
        {{if $code->forfait !== null}}
          ...
          <tr>
            <td>
              <span class="circled" title="{{tr}}CDatedCodeCCAM.forfait.{{$code->forfait}}-desc{{/tr}}" style="color: firebrick; border-color: firebrick; cursor: help;">
