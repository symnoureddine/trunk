 ...
 * Description
 */
class CRequestBulkTest extends UnitTestMediboard
{
    ...
    public function testCreateRequestsFailed(Request $request, string $exception_message_expected)
    {
        ...
        $bulk = new CRequestBulk($request_api);
                ...
                new Request(
                    [], [], [], [], [], ['REQUEST_TIME' => 10, 'REQUEST_TIME_FLOAT' => 10.0], json_encode(
                          [
                              'data' => [
                                  [
                                      CRequestBulk::KEY_ID     => '1',
                                      CRequestBulk::KEY_PATH   => 'path',
                                      CRequestBulk::KEY_METHOD => 'get',
                                  ],
                              ],
                          ]
                      )
                    ...
                    [], [], [], [], [], ['REQUEST_TIME' => 10, 'REQUEST_TIME_FLOAT' => 10.0], json_encode(
                          [
                              'data' => [
                                  ...
                                  [
                                      CRequestBulk::KEY_ID     => 'toto',
                                      CRequestBulk::KEY_PATH   => 'new_path',
                                      CRequestBulk::KEY_METHOD => 'post',
                                  ],
                              ],
                          ]
                      )
    ...
    {
        // Disable requestTime
        $singleRequestBulk = Request::create($path, $method, [], [], [], ['REQUEST_TIME' => 10, 'REQUEST_TIME_FLOAT' => 10.0]);
        $singleRequestBulk->headers->add([CRequestBulk::HEADER_SUB_REQUEST => true]);
    ...
    {
        $data = ['data' => []];
        for ($i = 0; $i < CRequestBulk::MAX_OPERATIONS * 2; $i++) {
            $data['data'][] = 'foo';
        }
