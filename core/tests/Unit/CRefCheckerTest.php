 ...
 */
class CRefCheckerTest extends UnitTestMediboard
{

    const CLASS_ABSTRACT     = 'CModuleActionLog';
    const CLASS_MODEL        = 'CAccessLog';
    ...
    function checkMetaProvider()
    {
        return [
            ...
            //        $this->makeSpec('object_class', 'str')
            //      ],
            [
                true,
                $this->makeSpec('object_id', 'ref class|' . static::CLASS_ABSTRACT . ' meta|object_class'),
            ...
            [
                true,
                $this->makeSpec('object_id', 'ref class|CMbObject meta|object_class'),
                $this->makeSpec('object_class', 'enum list|' . static::CLASS_MODEL),
            ],
            // succes
            [
