 ...
 * Description
 */
class CRequirementsManagerTest extends UnitTestMediboard {
  ...
  public function testCountable() {
    ...
    $this->isCountable($requirements_test, count($items));
  }
  ...
  public function testIterable() {
    ...
    $requirements_test->checkRequirements();
    $items = $requirements_test->getItems();
    $this->isIterable($requirements_test, $items, count($items));
  }
  ...
  public function providerAssertConfEquals() {
    return [
      ...
      ["webservices soap_server_encoding", "foo"],
    ];
  }
   ...
   * @config [CConfiguration] system object_handlers CAppFineClientHandler 1
   * @config [CConfiguration] system object_handlers CSaEventObjectHandler 0
   * @config [CConfiguration] webservices soap_server_encoding foo
   */
