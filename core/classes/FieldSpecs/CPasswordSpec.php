...
class CPasswordSpec extends CMbFieldSpec {
  ...
  function getFormHtmlElement($object, $params, $value, $className) {
    ...
    $sHtml = '<input type="password" placeholder="' . $placeholder . '" name="' . $name . '" class="' . CMbString::htmlSpecialChars(trim($className . ' ' . $this->prop)) . ' styled-element" ';
  ...
  function getLitteralDescription() {
    ...
    if ($this->minLength) {
      $litteral .= CAppUI::tr("CPasswordSpec-msg-password at least character", array($this->minLength));
    }
