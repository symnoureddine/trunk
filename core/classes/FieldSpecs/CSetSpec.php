    ...
    switch ($typeEnum) {
      case "select":
        ...
        foreach ($locales as $key => $item) {
          ...
          $sHtml .= "\n<option value=\"" . CMbString::htmlSpecialChars($key) . "\" $selected>" . CMbString::htmlSpecialChars($item) . "</option>";
        }
      ...
      case "checkbox":
        ...
        foreach ($locales as $key => $item) {
          ...
          $sHtml .= "\n<label>
              <input type=\"checkbox\" name=\"_{$name}_" . CMbString::htmlSpecialChars($key) . "\" value=\"" . CMbString::htmlSpecialChars($key) . "\" class=\"set-checkbox token$uid\" $selected $readonly  />
