    ...
    switch ($typeEnum) {
      ...
      case "select":
        ...
        foreach ($locales as $key => $item) {
          ...
          $html .= "\n<option value=\"" . CMbString::htmlSpecialChars($key, ENT_COMPAT, false) . "\" $selected>" . CMbString::htmlSpecialChars($item, ENT_COMPAT, false) . "</option>";
        }
      ...
      case "radio":
        ...
        foreach ($locales as $key => $item) {
          ...
          $html .= "\n<input type=\"radio\" name=\"$name\" value=\"" . CMbString::htmlSpecialChars($key, ENT_COMPAT, false) . "\" $selected class=\"$className\" $disabled $extra />
                       <label for=\"{$name}_" . CMbString::htmlSpecialChars($key, ENT_COMPAT, false) . "\">" . CMbString::htmlSpecialChars($item, ENT_COMPAT, false) . "</label> ";
          $compteur++;
