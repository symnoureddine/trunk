...
final class ButtonPlugin {
  ...
  /** @var string|null */
  private $serialized_parameters = null;
   ...
   */
  public function __construct(string $label, string $class_names, bool $disabled, string $module_name, string $onclick, string $script_name) {
    $this->label       = $label;
  ...
  /**
   * Todo: Inject a LocaleManager into ButtonPluginManager and make it give the translated label instead of translating it here
   *
   * @return string
   */
