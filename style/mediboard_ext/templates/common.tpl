...
{{*  <link href="http://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet">*}}
  ...
  <link href="style/mediboard_ext/vendor/fonts/materialdesignicons/materialdesignicons.min.css" rel="stylesheet">
...
{{mb_include style=mediboard_ext template=obsolete_browser ignore_errors=true}}
